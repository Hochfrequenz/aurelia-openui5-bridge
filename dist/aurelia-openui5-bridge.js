        ...
        defaultFunc() {
         ...
         if (this.ui5Id)
          ...
          this._object = new sap.ui.base.Object(params);
                                                  if(this.ui5Class)
           this._object.addStyleClass(this.ui5Class);
                                             if(this.ui5Tooltip)
           this._object.setTooltip(this.ui5Tooltip);                                             
        ...
        defaultFunc() {
         ...
         if (this.ui5Id)
          ...
          this._segmentedbutton = new sap.m.SegmentedButton(params);
                                                  if(this.ui5Class)
           this._segmentedbutton.addStyleClass(this.ui5Class);
                                             if(this.ui5Tooltip)
           this._segmentedbutton.setTooltip(this.ui5Tooltip);                                             
        ...
        defaultFunc() {
         ...
         if (this.ui5Id)
          ...
          this._standardtile = new sap.m.StandardTile(params);
                                                  if(this.ui5Class)
           this._standardtile.addStyleClass(this.ui5Class);
                                             if(this.ui5Tooltip)
           this._standardtile.setTooltip(this.ui5Tooltip);                                             
...
/* inherited from sap.ui.base.Object*/
    ...
    addChild(child, elem, afterElement) {
        ...
        for (elem of path) {
        try{
                 if (elem.localName == 'items') { var _index = afterElement?Math.floor(afterElement+1):null; if (_index)this._tree.insertItem(child, _index); else this._tree.addItem(child, 0);  return elem.localName; }
        ...
        defaultFunc() {
         ...
         if (this.ui5Id)
          ...
          this._uploadcollection = new sap.m.UploadCollection(params);
                                                  if(this.ui5Class)
           this._uploadcollection.addStyleClass(this.ui5Class);
                                             if(this.ui5Tooltip)
           this._uploadcollection.setTooltip(this.ui5Tooltip);                                             
        ...
        defaultFunc() {
         ...
         if (this.ui5Id)
          ...
          this._wizard = new sap.m.Wizard(params);
                                                  if(this.ui5Class)
           this._wizard.addStyleClass(this.ui5Class);
                                             if(this.ui5Tooltip)
           this._wizard.setTooltip(this.ui5Tooltip);                                             
