        ...
        execute: function () {
            ...
            _export('Ui5TextArea', Ui5TextArea = (_dec = customElement('ui5-text-area'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = bindable(), _dec23 = bindable(), _dec24 = bindable(), _dec25 = bindable(), _dec26 = bindable(), _dec27 = bindable(), _dec28 = bindable(), _dec29 = bindable(), _dec30 = bindable(), _dec31 = bindable(), _dec32 = bindable(), _dec33 = bindable(), _dec34 = bindable(), _dec35 = bindable(), _dec36 = bindable(), _dec37 = bindable(), _dec38 = computedFrom('_textarea'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5InputBase) {
                    ...
                    for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                        ...
                        try {
                            ...
                            if (elem.localName == 'dragdropconfig') {
                                var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._textarea.insertDragDropConfig(child, _index);else this._textarea.addDragDropConfig(child, 0);return elem.localName;
                            }
                        } catch (err) {}
                    }
                };
                ...
                Ui5TextArea.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
                    try {
                        ...
                        if (relation == 'dragdropconfig') {
                            this._textarea.removeDragDropConfig(child);
                        }
                    } catch (err) {}
                };
                ...
                Ui5TextArea.prototype.enabledChanged = function enabledChanged(newValue) {
                    if (this._textarea !== null) {
                        this._textarea.setEnabled(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5TextArea.prototype.editableChanged = function editableChanged(newValue) {
                    if (this._textarea !== null) {
                        this._textarea.setEditable(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5TextArea.prototype.showValueStateMessageChanged = function showValueStateMessageChanged(newValue) {
                    if (this._textarea !== null) {
                        this._textarea.setShowValueStateMessage(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5TextArea.prototype.requiredChanged = function requiredChanged(newValue) {
                    if (this._textarea !== null) {
                        this._textarea.setRequired(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5TextArea.prototype.blockedChanged = function blockedChanged(newValue) {
                    if (this._textarea !== null) {
                        this._textarea.setBlocked(getBooleanFromAttributeValue(newValue));
                    }
                };

                Ui5TextArea.prototype.busyChanged = function busyChanged(newValue) {
                    if (this._textarea !== null) {
                        this._textarea.setBusy(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5TextArea.prototype.visibleChanged = function visibleChanged(newValue) {
                    if (this._textarea !== null) {
                        this._textarea.setVisible(getBooleanFromAttributeValue(newValue));
                    }
                };
            ...
            _export('Ui5TextArea', Ui5TextArea);
        }
    };
});
//# sourceMappingURL=../dist/dev/text-area/text-area.js.map
