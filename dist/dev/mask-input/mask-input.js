    ...
    return {
        ...
        execute: function () {
            ...
            _export('Ui5MaskInput', Ui5MaskInput = (_dec = customElement('ui5-mask-input'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = bindable(), _dec23 = bindable(), _dec24 = bindable(), _dec25 = bindable(), _dec26 = bindable(), _dec27 = bindable(), _dec28 = bindable(), _dec29 = bindable(), _dec30 = computedFrom('_maskinput'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5InputBase) {
                    ...
                    for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                        ...
                        try {
                            ...
                            if (elem.localName == 'dragdropconfig') {
                                var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._maskinput.insertDragDropConfig(child, _index);else this._maskinput.addDragDropConfig(child, 0);return elem.localName;
                            }
                        } catch (err) {}
                    }
                };
                ...
                Ui5MaskInput.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
                    try {
                        ...
                        if (relation == 'dragdropconfig') {
                            this._maskinput.removeDragDropConfig(child);
                        }
                    } catch (err) {}
                };
                ...
                Ui5MaskInput.prototype.blockedChanged = function blockedChanged(newValue) {
                    if (this._maskinput !== null) {
                        this._maskinput.setBlocked(getBooleanFromAttributeValue(newValue));
                    }
                };
