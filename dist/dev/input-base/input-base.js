        ...
        execute: function () {
            ...
            _export('Ui5InputBase', Ui5InputBase = (_dec = customElement('ui5-input-base'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = bindable(), _dec23 = bindable(), _dec24 = bindable(), _dec25 = bindable(), _dec26 = bindable(), _dec27 = computedFrom('_inputbase'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5InputBase(element) {
                    ...
                    _initDefineProp(_this, 'valueState', _descriptor6, _this);

                    _initDefineProp(_this, 'name', _descriptor7, _this);

                    _initDefineProp(_this, 'placeholder', _descriptor8, _this);

                    _initDefineProp(_this, 'editable', _descriptor9, _this);

                    _initDefineProp(_this, 'valueStateText', _descriptor10, _this);

                    _initDefineProp(_this, 'showValueStateMessage', _descriptor11, _this);

                    _initDefineProp(_this, 'textAlign', _descriptor12, _this);

                    _initDefineProp(_this, 'textDirection', _descriptor13, _this);

                    _initDefineProp(_this, 'required', _descriptor14, _this);

                    _initDefineProp(_this, 'change', _descriptor15, _this);
                    ...
                    try {
                        if ($(this.element).closest("[ui5-container]").length > 0) {
                            if (this._parent && this._relation) {
                                if (this._inputbase) this._parent.removeChildByRelation(this._inputbase, this._relation);
                            }
                        } else {
                    ...
                    for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                        ...
                        try {
                            ...
                            if (elem.localName == 'customdata') {
                                var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._inputbase.insertCustomData(child, _index);else this._inputbase.addCustomData(child, 0);return elem.localName;
                            }
                            if (elem.localName == 'layoutdata') {
                                this._inputbase.setLayoutData(child);return elem.localName;
                            }
                            if (elem.localName == 'dependents') {
                                var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._inputbase.insertDependent(child, _index);else this._inputbase.addDependent(child, 0);return elem.localName;
                            }
                        } catch (err) {}
                    }
                };
            ...
            }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'enabled', [_dec5], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'valueState', [_dec6], {
                enumerable: true,
                initializer: function initializer() {
                    return 'None';
                }
            }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'name', [_dec7], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'placeholder', [_dec8], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'editable', [_dec9], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'valueStateText', [_dec10], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'showValueStateMessage', [_dec11], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            ...
            }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, 'required', [_dec14], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, 'change', [_dec15], {
                enumerable: true,
                initializer: function initializer() {
...
//# sourceMappingURL=../dist/dev/input-base/input-base.js.map
