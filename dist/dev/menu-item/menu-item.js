        ...
        execute: function () {
            ...
            _export('Ui5MenuItem', Ui5MenuItem = (_dec = customElement('ui5-menu-item'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = computedFrom('_menuitem'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Item) {
                ...
                function Ui5MenuItem(element) {
                    ...
                    _initDefineProp(_this, 'startsSection', _descriptor5, _this);

                    _initDefineProp(_this, 'press', _descriptor6, _this);

                    _initDefineProp(_this, 'propertyChanged', _descriptor7, _this);

                    _initDefineProp(_this, 'aggregationChanged', _descriptor8, _this);
            ...
            }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'startsSection', [_dec5], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            ...
            }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'propertyChanged', [_dec7], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'aggregationChanged', [_dec8], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            ...
            }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'enabled', [_dec10], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            ...
            }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'key', [_dec12], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
