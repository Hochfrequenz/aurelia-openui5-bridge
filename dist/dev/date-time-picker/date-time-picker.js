...
System.register(['aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../date-picker/date-picker'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
                    ...
                    if ($(this.element).closest("[ui5-container]").length > 0) {
                        ...
                        if (!this._parent.UIElement || this._parent.UIElement.sId != this._datetimepicker.sId) {
                            ...
                            if (this.element.previousElementSibling && this.element.previousElementSibling.au) {
                                ...
                                this._relation = this._parent.addChild(this._datetimepicker, this.element, prevSibling);
                            } else this._relation = this._parent.addChild(this._datetimepicker, this.element);
                            this.attributeManager.addAttributes({ "ui5-container": '' });
                        }
                    } else {
                    ...
                    for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                        ...
                        try {
                            if (elem.localName == 'specialdates') {
                                var _index = null;if (afterElement) _index = this._datetimepicker.indexOfSpecialDate(afterElement);if (_index) this._datetimepicker.insertSpecialDate(child, _index + 1);else this._datetimepicker.addSpecialDate(child, 0);return elem.localName;
                            }
                            if (elem.localName == 'tooltip') {
                                this._datetimepicker.setTooltip(child);return elem.localName;
                            }
                            if (elem.localName == 'customdata') {
                                var _index = null;if (afterElement) _index = this._datetimepicker.indexOfCustomData(afterElement);if (_index) this._datetimepicker.insertCustomData(child, _index + 1);else this._datetimepicker.addCustomData(child, 0);return elem.localName;
                            }
                            if (elem.localName == 'layoutdata') {
                                this._datetimepicker.setLayoutData(child);return elem.localName;
                            }
                            if (elem.localName == 'dependents') {
                                var _index = null;if (afterElement) _index = this._datetimepicker.indexOfDependent(afterElement);if (_index) this._datetimepicker.insertDependent(child, _index + 1);else this._datetimepicker.addDependent(child, 0);return elem.localName;
                            }
                        } catch (err) {}
                    }
                };
            ...
            }), _descriptor25 = _applyDecoratedDescriptor(_class2.prototype, 'busyIndicatorSize', [_dec26], {
                enumerable: true,
                initializer: function initializer() {
                    return 'Medium';
                }
            }), _descriptor26 = _applyDecoratedDescriptor(_class2.prototype, 'visible', [_dec27], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            }), _descriptor27 = _applyDecoratedDescriptor(_class2.prototype, 'fieldGroupIds', [_dec28], {
                enumerable: true,
                initializer: function initializer() {
                    return '[]';
                }
            }), _descriptor28 = _applyDecoratedDescriptor(_class2.prototype, 'validateFieldGroup', [_dec29], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor29 = _applyDecoratedDescriptor(_class2.prototype, 'validationSuccess', [_dec30], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor30 = _applyDecoratedDescriptor(_class2.prototype, 'validationError', [_dec31], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor31 = _applyDecoratedDescriptor(_class2.prototype, 'parseError', [_dec32], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor32 = _applyDecoratedDescriptor(_class2.prototype, 'formatError', [_dec33], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor33 = _applyDecoratedDescriptor(_class2.prototype, 'modelContextChange', [_dec34], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _applyDecoratedDescriptor(_class2.prototype, 'UIElement', [_dec35], Object.getOwnPropertyDescriptor(_class2.prototype, 'UIElement'), _class2.prototype)), _class2)) || _class) || _class));
