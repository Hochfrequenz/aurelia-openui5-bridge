        ...
        execute: function () {
            ...
            _export('Ui5ViewSettingsDialog', Ui5ViewSettingsDialog = (_dec = customElement('ui5-view-settings-dialog'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = computedFrom('_viewsettingsdialog'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5ViewSettingsDialog(element) {
                    ...
                    _initDefineProp(_this, 'sortDescending', _descriptor4, _this);

                    _initDefineProp(_this, 'groupDescending', _descriptor5, _this);

                    _initDefineProp(_this, 'filterSearchOperator', _descriptor6, _this);

                    _initDefineProp(_this, 'confirm', _descriptor7, _this);

                    _initDefineProp(_this, 'cancel', _descriptor8, _this);

                    _initDefineProp(_this, 'resetFilters', _descriptor9, _this);

                    _initDefineProp(_this, 'filterDetailPageOpened', _descriptor10, _this);
            ...
            }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, 'sortDescending', [_dec4], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'groupDescending', [_dec5], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'filterSearchOperator', [_dec6], {
                enumerable: true,
                initializer: function initializer() {
                    return 'StartsWith';
                }
            }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'confirm', [_dec7], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'cancel', [_dec8], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'resetFilters', [_dec9], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'filterDetailPageOpened', [_dec10], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
...
//# sourceMappingURL=../dist/dev/view-settings-dialog/view-settings-dialog.js.map
