        ...
        execute: function () {
            ...
            _export('Ui5MessageItem', Ui5MessageItem = (_dec = customElement('ui5-message-item'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = computedFrom('_messageitem'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Item) {
                ...
                function Ui5MessageItem(element) {
                    ...
                    _initDefineProp(_this, 'activeTitle', _descriptor13, _this);

                    _initDefineProp(_this, 'text', _descriptor14, _this);

                    _initDefineProp(_this, 'enabled', _descriptor15, _this);

                    _initDefineProp(_this, 'textDirection', _descriptor16, _this);

                    _initDefineProp(_this, 'key', _descriptor17, _this);
                ...
                Ui5MessageItem.prototype.typeChanged = function typeChanged(newValue) {
                    if (newValue != null && newValue != undefined && this._messageitem !== null) {
                ...
                Ui5MessageItem.prototype.activeTitleChanged = function activeTitleChanged(newValue) {
                    if (newValue != null && newValue != undefined && this._messageitem !== null) {
                        this._messageitem.setActiveTitle(getBooleanFromAttributeValue(newValue));
                    }
                };
            ...
            }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'activeTitle', [_dec11], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, 'text', [_dec12], {
                enumerable: true,
                initializer: function initializer() {
                    return '';
                }
            }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, 'enabled', [_dec13], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            ...
            }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, 'key', [_dec15], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
