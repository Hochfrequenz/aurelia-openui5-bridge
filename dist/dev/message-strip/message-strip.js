...
System.register(['aurelia-templating', 'aurelia-dependency-injection', '../common/attributeManager', '../common/attributes'], function (_export, _context) {
  ...
  var bindable, customElement, noView, inject, AttributeManager, getBooleanFromAttributeValue, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, Ui5MessageStrip;
  ...
  return {
    ...
    execute: function () {
      _export('Ui5MessageStrip', Ui5MessageStrip = (_dec = customElement('ui5-message-strip'), _dec2 = inject(Element), _dec(_class = _dec2(_class = (_class2 = function () {
