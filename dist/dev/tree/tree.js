        ...
        execute: function () {
            ...
            _export('Ui5Tree', Ui5Tree = (_dec = customElement('ui5-tree'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = bindable(), _dec23 = bindable(), _dec24 = bindable(), _dec25 = bindable(), _dec26 = bindable(), _dec27 = bindable(), _dec28 = bindable(), _dec29 = bindable(), _dec30 = bindable(), _dec31 = bindable(), _dec32 = bindable(), _dec33 = bindable(), _dec34 = bindable(), _dec35 = bindable(), _dec36 = bindable(), _dec37 = bindable(), _dec38 = bindable(), _dec39 = bindable(), _dec40 = bindable(), _dec41 = bindable(), _dec42 = bindable(), _dec43 = bindable(), _dec44 = computedFrom('_tree'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5ListBase) {
                ...
                function Ui5Tree(element) {
                    ...
                    _initDefineProp(_this, 'toggleOpenState', _descriptor5, _this);
                    ...
                    _initDefineProp(_this, 'sticky', _descriptor26, _this);
                    ...
                    _initDefineProp(_this, 'beforeOpenContextMenu', _descriptor33, _this);

                    _initDefineProp(_this, 'blocked', _descriptor34, _this);

                    _initDefineProp(_this, 'busy', _descriptor35, _this);

                    _initDefineProp(_this, 'busyIndicatorDelay', _descriptor36, _this);

                    _initDefineProp(_this, 'busyIndicatorSize', _descriptor37, _this);

                    _initDefineProp(_this, 'visible', _descriptor38, _this);

                    _initDefineProp(_this, 'fieldGroupIds', _descriptor39, _this);

                    _initDefineProp(_this, 'validateFieldGroup', _descriptor40, _this);

                    _initDefineProp(_this, 'validationSuccess', _descriptor41, _this);

                    _initDefineProp(_this, 'validationError', _descriptor42, _this);

                    _initDefineProp(_this, 'parseError', _descriptor43, _this);

                    _initDefineProp(_this, 'formatError', _descriptor44, _this);

                    _initDefineProp(_this, 'modelContextChange', _descriptor45, _this);
                ...
                Ui5Tree.prototype.attached = function attached() {
                    ...
                    if (this.ui5Class) this._tree.addStyleClass(this.ui5Class);
                    if (this.ui5Tooltip) this._tree.setTooltip(this.ui5Tooltip);
                ...
                Ui5Tree.prototype.toggleOpenStateChanged = function toggleOpenStateChanged(newValue) {
                    if (newValue != null && newValue != undefined && this._tree !== null) {
                ...
                Ui5Tree.prototype.stickyChanged = function stickyChanged(newValue) {
                    if (this._tree !== null) {
                        this._tree.setSticky(newValue);
                    }
                };
                ...
                Ui5Tree.prototype.blockedChanged = function blockedChanged(newValue) {
                    if (this._tree !== null) {
                        this._tree.setBlocked(getBooleanFromAttributeValue(newValue));
                    }
                };
            ...
            }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'toggleOpenState', [_dec3], {
                enumerable: true,
                initializer: function initializer() {
            ...
            }), _descriptor26 = _applyDecoratedDescriptor(_class2.prototype, 'sticky', [_dec24], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor27 = _applyDecoratedDescriptor(_class2.prototype, 'selectionChange', [_dec25], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor28 = _applyDecoratedDescriptor(_class2.prototype, 'delete', [_dec26], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor29 = _applyDecoratedDescriptor(_class2.prototype, 'swipe', [_dec27], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor30 = _applyDecoratedDescriptor(_class2.prototype, 'updateStarted', [_dec28], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor31 = _applyDecoratedDescriptor(_class2.prototype, 'updateFinished', [_dec29], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor32 = _applyDecoratedDescriptor(_class2.prototype, 'itemPress', [_dec30], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor33 = _applyDecoratedDescriptor(_class2.prototype, 'beforeOpenContextMenu', [_dec31], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor34 = _applyDecoratedDescriptor(_class2.prototype, 'blocked', [_dec32], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor35 = _applyDecoratedDescriptor(_class2.prototype, 'busy', [_dec33], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor36 = _applyDecoratedDescriptor(_class2.prototype, 'busyIndicatorDelay', [_dec34], {
                enumerable: true,
                initializer: function initializer() {
                    return 1000;
                }
            }), _descriptor37 = _applyDecoratedDescriptor(_class2.prototype, 'busyIndicatorSize', [_dec35], {
                enumerable: true,
                initializer: function initializer() {
                    return 'Medium';
                }
            }), _descriptor38 = _applyDecoratedDescriptor(_class2.prototype, 'visible', [_dec36], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            }), _descriptor39 = _applyDecoratedDescriptor(_class2.prototype, 'fieldGroupIds', [_dec37], {
                enumerable: true,
                initializer: function initializer() {
                    return '[]';
                }
            }), _descriptor40 = _applyDecoratedDescriptor(_class2.prototype, 'validateFieldGroup', [_dec38], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor41 = _applyDecoratedDescriptor(_class2.prototype, 'validationSuccess', [_dec39], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor42 = _applyDecoratedDescriptor(_class2.prototype, 'validationError', [_dec40], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor43 = _applyDecoratedDescriptor(_class2.prototype, 'parseError', [_dec41], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor44 = _applyDecoratedDescriptor(_class2.prototype, 'formatError', [_dec42], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor45 = _applyDecoratedDescriptor(_class2.prototype, 'modelContextChange', [_dec43], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
