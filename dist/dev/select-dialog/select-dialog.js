        ...
        execute: function () {
            ...
            _export('Ui5SelectDialog', Ui5SelectDialog = (_dec = customElement('ui5-select-dialog'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = bindable(), _dec23 = bindable(), _dec24 = bindable(), _dec25 = computedFrom('_selectdialog'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5SelectDialog(element) {
                    ...
                    _initDefineProp(_this, 'rememberSelections', _descriptor10, _this);

                    _initDefineProp(_this, 'contentHeight', _descriptor11, _this);

                    _initDefineProp(_this, 'confirm', _descriptor12, _this);

                    _initDefineProp(_this, 'search', _descriptor13, _this);

                    _initDefineProp(_this, 'liveChange', _descriptor14, _this);

                    _initDefineProp(_this, 'cancel', _descriptor15, _this);
            ...
            }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'contentWidth', [_dec7], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'rememberSelections', [_dec8], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'contentHeight', [_dec9], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'confirm', [_dec10], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'search', [_dec11], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
            ...
            }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, 'cancel', [_dec13], {
                enumerable: true,
                initializer: function initializer() {
                    return this.defaultFunc;
                }
