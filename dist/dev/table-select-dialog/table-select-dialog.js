        ...
        execute: function () {
            ...
            _export('Ui5TableSelectDialog', Ui5TableSelectDialog = (_dec = customElement('ui5-table-select-dialog'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = bindable(), _dec23 = bindable(), _dec24 = bindable(), _dec25 = bindable(), _dec26 = bindable(), _dec27 = bindable(), _dec28 = bindable(), _dec29 = bindable(), _dec30 = bindable(), _dec31 = computedFrom('_tableselectdialog'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                Ui5TableSelectDialog.prototype.growingChanged = function growingChanged(newValue) {
                    if (newValue != null && newValue != undefined && this._tableselectdialog !== null) {
                        this._tableselectdialog.setGrowing(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5TableSelectDialog.prototype.showClearButtonChanged = function showClearButtonChanged(newValue) {
                    if (newValue != null && newValue != undefined && this._tableselectdialog !== null) {
                        this._tableselectdialog.setShowClearButton(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5TableSelectDialog.prototype.draggableChanged = function draggableChanged(newValue) {
                    if (newValue != null && newValue != undefined && this._tableselectdialog !== null) {
                        this._tableselectdialog.setDraggable(getBooleanFromAttributeValue(newValue));
                    }
                };

                Ui5TableSelectDialog.prototype.resizableChanged = function resizableChanged(newValue) {
                    if (newValue != null && newValue != undefined && this._tableselectdialog !== null) {
                        this._tableselectdialog.setResizable(getBooleanFromAttributeValue(newValue));
                    }
                };
