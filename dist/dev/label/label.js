        ...
        execute: function () {
            ...
            _export('Ui5Label', Ui5Label = (_dec = customElement('ui5-label'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = bindable(), _dec23 = bindable(), _dec24 = bindable(), _dec25 = computedFrom('_label'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5Label(element) {
                    ...
                    _initDefineProp(_this, 'wrappingType', _descriptor13, _this);

                    _initDefineProp(_this, 'vAlign', _descriptor14, _this);
                ...
                Ui5Label.prototype.designChanged = function designChanged(newValue) {
                    if (newValue != null && newValue != undefined && this._label !== null) {
                ...
                Ui5Label.prototype.wrappingTypeChanged = function wrappingTypeChanged(newValue) {
                    if (newValue != null && newValue != undefined && this._label !== null) {
                        this._label.setWrappingType(newValue);
                    }
                };
                ...
                Ui5Label.prototype.blockedChanged = function blockedChanged(newValue) {
                    if (this._label !== null) {
                        this._label.setBlocked(getBooleanFromAttributeValue(newValue));
                    }
                };
            ...
            }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'wrappingType', [_dec11], {
                enumerable: true,
                initializer: function initializer() {
                    return 'Normal';
                }
            }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, 'vAlign', [_dec12], {
                enumerable: true,
                initializer: function initializer() {
                    return 'Inherit';
                }
