        ...
        execute: function () {
            ...
            _export('Ui5FeedContent', Ui5FeedContent = (_dec = customElement('ui5-feed-content'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = computedFrom('_feedcontent'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5FeedContent(element) {
                    ...
                    _initDefineProp(_this, 'contentText', _descriptor3, _this);

                    _initDefineProp(_this, 'subheader', _descriptor4, _this);

                    _initDefineProp(_this, 'value', _descriptor5, _this);

                    _initDefineProp(_this, 'valueColor', _descriptor6, _this);

                    _initDefineProp(_this, 'truncateValueTo', _descriptor7, _this);
            ...
            }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, 'contentText', [_dec3], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, 'subheader', [_dec4], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            ...
            }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'valueColor', [_dec6], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'truncateValueTo', [_dec7], {
                enumerable: true,
                initializer: function initializer() {
                    return 4;
                }
            }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'press', [_dec8], {
                enumerable: true,
                initializer: function initializer() {
