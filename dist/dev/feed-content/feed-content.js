...
System.register(['aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export('Ui5FeedContent', Ui5FeedContent = (_dec = customElement('ui5-feed-content'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = computedFrom('_feedcontent'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5FeedContent(element) {
                    ...
                    _initDefineProp(_this, 'contentText', _descriptor5, _this);

                    _initDefineProp(_this, 'subheader', _descriptor6, _this);

                    _initDefineProp(_this, 'value', _descriptor7, _this);

                    _initDefineProp(_this, 'valueColor', _descriptor8, _this);

                    _initDefineProp(_this, 'truncateValueTo', _descriptor9, _this);
                ...
                Ui5FeedContent.prototype.attached = function attached() {
                    ...
                    if (this.ui5Class) this._feedcontent.addStyleClass(this.ui5Class);
                    if (this.ui5Tooltip) this._feedcontent.setTooltip(this.ui5Tooltip);
                    ...
                    try {
                        if ($(this.element).closest("[ui5-container]").length > 0) {
                            if (this._parent && this._relation) {
                                if (this._feedcontent) this._parent.removeChildByRelation(this._feedcontent, this._relation);
                            }
                        } else {
                    ...
                    for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                        ...
                        try {
                            ...
                            if (elem.localName == 'customdata') {
                                var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._feedcontent.insertCustomData(child, _index);else this._feedcontent.addCustomData(child, 0);return elem.localName;
                            }
                            if (elem.localName == 'layoutdata') {
                                this._feedcontent.setLayoutData(child);return elem.localName;
                            }
                            if (elem.localName == 'dependents') {
                                var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._feedcontent.insertDependent(child, _index);else this._feedcontent.addDependent(child, 0);return elem.localName;
                            }
                            if (elem.localName == 'dragdropconfig') {
                                var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._feedcontent.insertDragDropConfig(child, _index);else this._feedcontent.addDragDropConfig(child, 0);return elem.localName;
                            }
                        } catch (err) {}
                    }
                };
                ...
                Ui5FeedContent.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
                    try {
                        ...
                        if (relation == 'dragdropconfig') {
                            this._feedcontent.removeDragDropConfig(child);
                        }
                    } catch (err) {}
                };
                ...
                Ui5FeedContent.prototype.busyChanged = function busyChanged(newValue) {
                    if (this._feedcontent !== null) {
                        this._feedcontent.setBusy(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5FeedContent.prototype.busyIndicatorSizeChanged = function busyIndicatorSizeChanged(newValue) {
                    if (this._feedcontent !== null) {
                        this._feedcontent.setBusyIndicatorSize(newValue);
                    }
                };

                Ui5FeedContent.prototype.visibleChanged = function visibleChanged(newValue) {
                    if (this._feedcontent !== null) {
                        this._feedcontent.setVisible(getBooleanFromAttributeValue(newValue));
                    }
                };
            ...
            }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'contentText', [_dec3], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'subheader', [_dec4], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            ...
            }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'valueColor', [_dec6], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'truncateValueTo', [_dec7], {
                enumerable: true,
                initializer: function initializer() {
                    return 4;
                }
...
//# sourceMappingURL=../dist/dev/feed-content/feed-content.js.map
