    ...
    return {
        ...
        execute: function () {
            ...
            _export('Ui5TileContainer', Ui5TileContainer = (_dec = customElement('ui5-tile-container'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = computedFrom('_tilecontainer'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                    ...
                    for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                        ...
                        try {
                            ...
                            if (elem.localName == 'dragdropconfig') {
                                var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._tilecontainer.insertDragDropConfig(child, _index);else this._tilecontainer.addDragDropConfig(child, 0);return elem.localName;
                            }
                        } catch (err) {}
                    }
                };
                ...
                Ui5TileContainer.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
                    try {
                        ...
                        if (relation == 'dragdropconfig') {
                            this._tilecontainer.removeDragDropConfig(child);
                        }
                    } catch (err) {}
                };
                ...
                Ui5TileContainer.prototype.blockedChanged = function blockedChanged(newValue) {
                    if (this._tilecontainer !== null) {
                        this._tilecontainer.setBlocked(getBooleanFromAttributeValue(newValue));
                    }
                };
