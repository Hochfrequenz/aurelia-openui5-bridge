...
System.register(['aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../element/element'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export('Ui5FormContainer', Ui5FormContainer = (_dec = customElement('ui5-form-container'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = computedFrom('_formcontainer'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Element) {
                ...
                function Ui5FormContainer(element) {
                    ...
                    _initDefineProp(_this, 'expanded', _descriptor5, _this);
                ...
                Ui5FormContainer.prototype.attached = function attached() {
                    ...
                    if (this.ui5Class) this._formcontainer.addStyleClass(this.ui5Class);
                    if (this.ui5Tooltip) this._formcontainer.setTooltip(this.ui5Tooltip);
                    ...
                    for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                        ...
                        try {
                            ...
                            if (elem.localName == 'dragdropconfig') {
                                var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._formcontainer.insertDragDropConfig(child, _index);else this._formcontainer.addDragDropConfig(child, 0);return elem.localName;
                            }
                        } catch (err) {}
                    }
                };
                ...
                Ui5FormContainer.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
                    try {
                        ...
                        if (relation == 'dragdropconfig') {
                            this._formcontainer.removeDragDropConfig(child);
                        }
                    } catch (err) {}
                };
            ...
            }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'expanded', [_dec3], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'expandable', [_dec4], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
...
//# sourceMappingURL=../dist/dev/form-container/form-container.js.map
