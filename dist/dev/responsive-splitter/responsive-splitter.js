...
System.register(['aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export('Ui5ResponsiveSplitter', Ui5ResponsiveSplitter = (_dec = customElement('ui5-responsive-splitter'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = computedFrom('_responsivesplitter'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                Ui5ResponsiveSplitter.prototype.busyChanged = function busyChanged(newValue) {
                    if (this._responsivesplitter !== null) {
                        this._responsivesplitter.setBusy(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5ResponsiveSplitter.prototype.visibleChanged = function visibleChanged(newValue) {
                    if (this._responsivesplitter !== null) {
                        this._responsivesplitter.setVisible(getBooleanFromAttributeValue(newValue));
                    }
                };
            ...
            _export('Ui5ResponsiveSplitter', Ui5ResponsiveSplitter);
        }
    };
});
//# sourceMappingURL=../dist/dev/responsive-splitter/responsive-splitter.js.map
