...
System.register(['aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export('Ui5Splitter', Ui5Splitter = (_dec = customElement('ui5-splitter'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = computedFrom('_splitter'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5Splitter(element) {
                    ...
                    _initDefineProp(_this, 'orientation', _descriptor3, _this);

                    _initDefineProp(_this, 'width', _descriptor4, _this);

                    _initDefineProp(_this, 'height', _descriptor5, _this);

                    _initDefineProp(_this, 'resize', _descriptor6, _this);
                ...
                Ui5Splitter.prototype.busyChanged = function busyChanged(newValue) {
                    if (this._splitter !== null) {
                        this._splitter.setBusy(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5Splitter.prototype.visibleChanged = function visibleChanged(newValue) {
                    if (this._splitter !== null) {
                        this._splitter.setVisible(getBooleanFromAttributeValue(newValue));
                    }
                };
            ...
            }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, 'orientation', [_dec3], {
                enumerable: true,
                initializer: function initializer() {
                    return 'Horizontal';
                }
            ...
            }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'resize', [_dec6], {
                enumerable: true,
                initializer: function initializer() {
            ...
            _export('Ui5Splitter', Ui5Splitter);
        }
    };
});
