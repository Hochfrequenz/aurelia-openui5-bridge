...
var Ui5ViewSettingsDialog = exports.Ui5ViewSettingsDialog = (_dec = (0, _aureliaTemplating.customElement)('ui5-view-settings-dialog'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec(_class = _dec2(_class = (_class2 = function () {
  ...
  Ui5ViewSettingsDialog.prototype.attached = function attached() {
    var props = {
      icon: this.icon,
      title: this.title,
      sortDescending: (0, _attributes.getBooleanFromAttributeValue)(this.sortDescending),
      groupDescending: (0, _attributes.getBooleanFromAttributeValue)(this.groupDescending),
  ...
  Ui5ViewSettingsDialog.prototype.sortDescendingChanged = function sortDescendingChanged(newValue) {
    if (this._dialog !== null) {
      this._dialog.setSortDescending((0, _attributes.getBooleanFromAttributeValue)(newValue));
    }
  };

  Ui5ViewSettingsDialog.prototype.groupDescendingChanged = function groupDescendingChanged(newValue) {
    if (this._dialog !== null) {
      this._dialog.setGroupDescending((0, _attributes.getBooleanFromAttributeValue)(newValue));
    }
  };
