...
var Ui5Tile = exports.Ui5Tile = (_dec = (0, _aureliaTemplating.customElement)('ui5-tile'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaFramework.computedFrom)('_tile'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
    ...
    function Ui5Tile(element) {
        ...
        _initDefineProp(_this, 'removable', _descriptor5, _this);
    ...
    Ui5Tile.prototype.fillProperties = function fillProperties(params) {
        params.removable = (0, _attributes.getBooleanFromAttributeValue)(this.removable);
    ...
    Ui5Tile.prototype.attached = function attached() {
        ...
        if (this.ui5Class) this._tile.addStyleClass(this.ui5Class);
        if (this.ui5Tooltip) this._tile.setTooltip(this.ui5Tooltip);
        ...
        try {
            if ($(this.element).closest("[ui5-container]").length > 0) {
                if (this._parent && this._relation) {
                    if (this._tile) this._parent.removeChildByRelation(this._tile, this._relation);
                }
            } else {
                this._tile.destroy();
            }
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'customdata') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._tile.insertCustomData(child, _index);else this._tile.addCustomData(child, 0);return elem.localName;
                }
                if (elem.localName == 'layoutdata') {
                    this._tile.setLayoutData(child);return elem.localName;
                }
                if (elem.localName == 'dependents') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._tile.insertDependent(child, _index);else this._tile.addDependent(child, 0);return elem.localName;
                }
                if (elem.localName == 'dragdropconfig') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._tile.insertDragDropConfig(child, _index);else this._tile.addDragDropConfig(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
    ...
    Ui5Tile.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
        try {
            ...
            if (relation == 'dragdropconfig') {
                this._tile.removeDragDropConfig(child);
            }
        } catch (err) {}
    };
    ...
    Ui5Tile.prototype.blockedChanged = function blockedChanged(newValue) {
        if (this._tile !== null) {
            this._tile.setBlocked((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };

    Ui5Tile.prototype.busyChanged = function busyChanged(newValue) {
        if (this._tile !== null) {
            this._tile.setBusy((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
    ...
    Ui5Tile.prototype.busyIndicatorSizeChanged = function busyIndicatorSizeChanged(newValue) {
        if (this._tile !== null) {
            this._tile.setBusyIndicatorSize(newValue);
        }
    };

    Ui5Tile.prototype.visibleChanged = function visibleChanged(newValue) {
        if (this._tile !== null) {
            this._tile.setVisible((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
...
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'removable', [_dec3], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
