...
var Ui5TabContainer = exports.Ui5TabContainer = (_dec = (0, _aureliaTemplating.customElement)('ui5-tab-container'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaFramework.computedFrom)('_tabcontainer'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
    ...
    Ui5TabContainer.prototype.attached = function attached() {
        ...
        if (this.ui5Class) this._tabcontainer.addStyleClass(this.ui5Class);
        if (this.ui5Tooltip) this._tabcontainer.setTooltip(this.ui5Tooltip);
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'dragdropconfig') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._tabcontainer.insertDragDropConfig(child, _index);else this._tabcontainer.addDragDropConfig(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
    ...
    Ui5TabContainer.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
        try {
            ...
            if (relation == 'dragdropconfig') {
                this._tabcontainer.removeDragDropConfig(child);
            }
        } catch (err) {}
    };
...
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'showAddNewButton', [_dec3], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
