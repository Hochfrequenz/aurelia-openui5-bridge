...
var Ui5ListBase = exports.Ui5ListBase = (_dec = (0, _aureliaTemplating.customElement)('ui5-list-base'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaTemplating.bindable)(), _dec27 = (0, _aureliaTemplating.bindable)(), _dec28 = (0, _aureliaTemplating.bindable)(), _dec29 = (0, _aureliaTemplating.bindable)(), _dec30 = (0, _aureliaTemplating.bindable)(), _dec31 = (0, _aureliaTemplating.bindable)(), _dec32 = (0, _aureliaTemplating.bindable)(), _dec33 = (0, _aureliaTemplating.bindable)(), _dec34 = (0, _aureliaTemplating.bindable)(), _dec35 = (0, _aureliaTemplating.bindable)(), _dec36 = (0, _aureliaTemplating.bindable)(), _dec37 = (0, _aureliaTemplating.bindable)(), _dec38 = (0, _aureliaTemplating.bindable)(), _dec39 = (0, _aureliaTemplating.bindable)(), _dec40 = (0, _aureliaFramework.computedFrom)('_listbase'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
    ...
    function Ui5ListBase(element) {
        ...
        _initDefineProp(_this, 'selectionChange', _descriptor22, _this);

        _initDefineProp(_this, 'delete', _descriptor23, _this);

        _initDefineProp(_this, 'swipe', _descriptor24, _this);

        _initDefineProp(_this, 'updateStarted', _descriptor25, _this);

        _initDefineProp(_this, 'updateFinished', _descriptor26, _this);

        _initDefineProp(_this, 'itemPress', _descriptor27, _this);
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'customdata') {
                    var _index = null;if (afterElement) _index = this._listbase.indexOfCustomData(afterElement);if (_index) this._listbase.insertCustomData(child, _index + 1);else this._listbase.addCustomData(child, 0);return elem.localName;
                }
                if (elem.localName == 'layoutdata') {
                    this._listbase.setLayoutData(child);return elem.localName;
                }
                if (elem.localName == 'dependents') {
                    var _index = null;if (afterElement) _index = this._listbase.indexOfDependent(afterElement);if (_index) this._listbase.insertDependent(child, _index + 1);else this._listbase.addDependent(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
...
}), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'showSeparators', [_dec14], {
    enumerable: true,
    initializer: function initializer() {
        return 'All';
    }
...
}), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, 'selectionChange', [_dec23], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor23 = _applyDecoratedDescriptor(_class2.prototype, 'delete', [_dec24], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
...
}), _descriptor25 = _applyDecoratedDescriptor(_class2.prototype, 'updateStarted', [_dec26], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
...
}), _descriptor27 = _applyDecoratedDescriptor(_class2.prototype, 'itemPress', [_dec28], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
...
}), _descriptor30 = _applyDecoratedDescriptor(_class2.prototype, 'busyIndicatorSize', [_dec31], {
    enumerable: true,
    initializer: function initializer() {
        return 'Medium';
    }
}), _descriptor31 = _applyDecoratedDescriptor(_class2.prototype, 'visible', [_dec32], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor32 = _applyDecoratedDescriptor(_class2.prototype, 'fieldGroupIds', [_dec33], {
    enumerable: true,
    initializer: function initializer() {
        return '[]';
    }
}), _descriptor33 = _applyDecoratedDescriptor(_class2.prototype, 'validateFieldGroup', [_dec34], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor34 = _applyDecoratedDescriptor(_class2.prototype, 'validationSuccess', [_dec35], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor35 = _applyDecoratedDescriptor(_class2.prototype, 'validationError', [_dec36], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor36 = _applyDecoratedDescriptor(_class2.prototype, 'parseError', [_dec37], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor37 = _applyDecoratedDescriptor(_class2.prototype, 'formatError', [_dec38], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor38 = _applyDecoratedDescriptor(_class2.prototype, 'modelContextChange', [_dec39], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
