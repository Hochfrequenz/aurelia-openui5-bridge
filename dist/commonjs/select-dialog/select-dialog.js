...
var Ui5SelectDialog = exports.Ui5SelectDialog = (_dec = (0, _aureliaTemplating.customElement)('ui5-select-dialog'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaTemplating.bindable)(), _dec27 = (0, _aureliaTemplating.bindable)(), _dec28 = (0, _aureliaTemplating.bindable)(), _dec29 = (0, _aureliaTemplating.bindable)(), _dec30 = (0, _aureliaTemplating.bindable)(), _dec31 = (0, _aureliaFramework.computedFrom)('_selectdialog'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
    ...
    Ui5SelectDialog.prototype.growingChanged = function growingChanged(newValue) {
        if (newValue != null && newValue != undefined && this._selectdialog !== null) {
            this._selectdialog.setGrowing((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
    ...
    Ui5SelectDialog.prototype.showClearButtonChanged = function showClearButtonChanged(newValue) {
        if (newValue != null && newValue != undefined && this._selectdialog !== null) {
            this._selectdialog.setShowClearButton((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };

    Ui5SelectDialog.prototype.confirmButtonTextChanged = function confirmButtonTextChanged(newValue) {
        if (newValue != null && newValue != undefined && this._selectdialog !== null) {
            this._selectdialog.setConfirmButtonText(newValue);
        }
    };

    Ui5SelectDialog.prototype.draggableChanged = function draggableChanged(newValue) {
        if (newValue != null && newValue != undefined && this._selectdialog !== null) {
            this._selectdialog.setDraggable((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };

    Ui5SelectDialog.prototype.resizableChanged = function resizableChanged(newValue) {
        if (newValue != null && newValue != undefined && this._selectdialog !== null) {
            this._selectdialog.setResizable((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };

    Ui5SelectDialog.prototype.titleAlignmentChanged = function titleAlignmentChanged(newValue) {
        if (newValue != null && newValue != undefined && this._selectdialog !== null) {
            this._selectdialog.setTitleAlignment(newValue);
        }
    };
