...
var Ui5IconTabBar = exports.Ui5IconTabBar = (_dec = (0, _aureliaTemplating.customElement)('ui5-icon-tab-bar'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaTemplating.bindable)(), _dec27 = (0, _aureliaTemplating.bindable)(), _dec28 = (0, _aureliaTemplating.bindable)(), _dec29 = (0, _aureliaFramework.computedFrom)('_icontabbar'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
    ...
    function Ui5IconTabBar(element) {
        ...
        _initDefineProp(_this, 'expandable', _descriptor5, _this);

        _initDefineProp(_this, 'expanded', _descriptor6, _this);

        _initDefineProp(_this, 'selectedKey', _descriptor7, _this);

        _initDefineProp(_this, 'upperCase', _descriptor8, _this);

        _initDefineProp(_this, 'stretchContentHeight', _descriptor9, _this);

        _initDefineProp(_this, 'applyContentPadding', _descriptor10, _this);

        _initDefineProp(_this, 'backgroundDesign', _descriptor11, _this);

        _initDefineProp(_this, 'headerMode', _descriptor12, _this);

        _initDefineProp(_this, 'showOverflowSelectList', _descriptor13, _this);

        _initDefineProp(_this, 'headerBackgroundDesign', _descriptor14, _this);

        _initDefineProp(_this, 'enableTabReordering', _descriptor15, _this);

        _initDefineProp(_this, 'tabDensityMode', _descriptor16, _this);

        _initDefineProp(_this, 'select', _descriptor17, _this);

        _initDefineProp(_this, 'expand', _descriptor18, _this);
    ...
    Ui5IconTabBar.prototype.fillProperties = function fillProperties(params) {
        ...
        params.upperCase = (0, _attributes.getBooleanFromAttributeValue)(this.upperCase);
        params.stretchContentHeight = (0, _attributes.getBooleanFromAttributeValue)(this.stretchContentHeight);
        params.applyContentPadding = (0, _attributes.getBooleanFromAttributeValue)(this.applyContentPadding);
    ...
    Ui5IconTabBar.prototype.attached = function attached() {
        ...
        if (this.ui5Class) this._icontabbar.addStyleClass(this.ui5Class);
        if (this.ui5Tooltip) this._icontabbar.setTooltip(this.ui5Tooltip);
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'dragdropconfig') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._icontabbar.insertDragDropConfig(child, _index);else this._icontabbar.addDragDropConfig(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
    ...
    Ui5IconTabBar.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
        try {
            ...
            if (relation == 'dragdropconfig') {
                this._icontabbar.removeDragDropConfig(child);
            }
        } catch (err) {}
    };
    ...
    Ui5IconTabBar.prototype.blockedChanged = function blockedChanged(newValue) {
        if (this._icontabbar !== null) {
            this._icontabbar.setBlocked((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };

    Ui5IconTabBar.prototype.busyChanged = function busyChanged(newValue) {
        if (this._icontabbar !== null) {
            this._icontabbar.setBusy((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
    ...
    Ui5IconTabBar.prototype.visibleChanged = function visibleChanged(newValue) {
        if (this._icontabbar !== null) {
            this._icontabbar.setVisible((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
...
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'expandable', [_dec3], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'expanded', [_dec4], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
...
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'upperCase', [_dec6], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'stretchContentHeight', [_dec7], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'applyContentPadding', [_dec8], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
...
}), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'headerMode', [_dec10], {
    enumerable: true,
    initializer: function initializer() {
        return 'Standard';
    }
}), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'showOverflowSelectList', [_dec11], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, 'headerBackgroundDesign', [_dec12], {
    enumerable: true,
    initializer: function initializer() {
        return 'Solid';
    }
}), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, 'enableTabReordering', [_dec13], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, 'tabDensityMode', [_dec14], {
    enumerable: true,
    initializer: function initializer() {
        return 'Cozy';
    }
}), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, 'select', [_dec15], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, 'expand', [_dec16], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
