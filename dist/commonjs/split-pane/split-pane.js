...
exports.Ui5SplitPane = undefined;
...
var Ui5SplitPane = exports.Ui5SplitPane = (_dec = (0, _aureliaTemplating.customElement)('ui5-split-pane'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaFramework.computedFrom)('_splitpane'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Element) {
    ...
    function Ui5SplitPane(element) {
        ...
        _initDefineProp(_this, 'demandPane', _descriptor3, _this);

        _initDefineProp(_this, 'requiredParentWidth', _descriptor4, _this);
    ...
    Ui5SplitPane.prototype.fillProperties = function fillProperties(params) {
        params.demandPane = (0, _attributes.getBooleanFromAttributeValue)(this.demandPane);
...
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, 'demandPane', [_dec3], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, 'requiredParentWidth', [_dec4], {
    enumerable: true,
    initializer: function initializer() {
        return 800;
    }
