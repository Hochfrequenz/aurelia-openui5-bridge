...
var Ui5InputBase = exports.Ui5InputBase = (_dec = (0, _aureliaTemplating.customElement)('ui5-input-base'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaTemplating.bindable)(), _dec27 = (0, _aureliaTemplating.bindable)(), _dec28 = (0, _aureliaFramework.computedFrom)('_inputbase'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
    ...
    Ui5InputBase.prototype.attached = function attached() {
        ...
        if (this.ui5Class) this._inputbase.addStyleClass(this.ui5Class);
        if (this.ui5Tooltip) this._inputbase.setTooltip(this.ui5Tooltip);
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'dragdropconfig') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._inputbase.insertDragDropConfig(child, _index);else this._inputbase.addDragDropConfig(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
    ...
    Ui5InputBase.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
        try {
            ...
            if (relation == 'dragdropconfig') {
                this._inputbase.removeDragDropConfig(child);
            }
        } catch (err) {}
    };
    ...
    Ui5InputBase.prototype.blockedChanged = function blockedChanged(newValue) {
        if (this._inputbase !== null) {
            this._inputbase.setBlocked((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
...
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'valueState', [_dec6], {
    enumerable: true,
    initializer: function initializer() {
        return 'None';
    }
...
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'editable', [_dec9], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'valueStateText', [_dec10], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'showValueStateMessage', [_dec11], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
...
}), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, 'required', [_dec14], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, 'change', [_dec15], {
    enumerable: true,
    initializer: function initializer() {
