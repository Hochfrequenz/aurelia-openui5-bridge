...
var Ui5ColumnListItem = exports.Ui5ColumnListItem = (_dec = (0, _aureliaTemplating.customElement)('ui5-column-list-item'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaFramework.computedFrom)('_columnlistitem'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5ListItemBase) {
    ...
    function Ui5ColumnListItem(element) {
        ...
        _initDefineProp(_this, 'tap', _descriptor9, _this);

        _initDefineProp(_this, 'detailTap', _descriptor10, _this);
    ...
    Ui5ColumnListItem.prototype.tapChanged = function tapChanged(newValue) {
        if (this._columnlistitem !== null) {
            this._columnlistitem.attachTap(newValue);
        }
    };

    Ui5ColumnListItem.prototype.detailTapChanged = function detailTapChanged(newValue) {
        if (this._columnlistitem !== null) {
            this._columnlistitem.attachDetailTap(newValue);
        }
    };
...
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'tap', [_dec10], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'detailTap', [_dec11], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'press', [_dec12], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'detailPress', [_dec13], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
