...
exports.Ui5CustomData = undefined;
...
var Ui5CustomData = exports.Ui5CustomData = (_dec = (0, _aureliaTemplating.customElement)('ui5-custom-data'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaFramework.computedFrom)('_customdata'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Element) {
    ...
    function Ui5CustomData(element) {
        ...
        _initDefineProp(_this, 'writeToDom', _descriptor7, _this);
    ...
    Ui5CustomData.prototype.attached = function attached() {
        ...
        if (this.ui5Class) this._customdata.addStyleClass(this.ui5Class);
        if (this.ui5Tooltip) this._customdata.setTooltip(this.ui5Tooltip);
        ...
        try {
            if ($(this.element).closest("[ui5-container]").length > 0) {
                if (this._parent && this._relation) {
                    if (this._customdata) this._parent.removeChildByRelation(this._customdata, this._relation);
                }
            } else {
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'customdata') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._customdata.insertCustomData(child, _index);else this._customdata.addCustomData(child, 0);return elem.localName;
                }
                if (elem.localName == 'layoutdata') {
                    this._customdata.setLayoutData(child);return elem.localName;
                }
                if (elem.localName == 'dependents') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._customdata.insertDependent(child, _index);else this._customdata.addDependent(child, 0);return elem.localName;
                }
                if (elem.localName == 'dragdropconfig') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._customdata.insertDragDropConfig(child, _index);else this._customdata.addDragDropConfig(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
    ...
    Ui5CustomData.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
        try {
            ...
            if (relation == 'dragdropconfig') {
                this._customdata.removeDragDropConfig(child);
            }
        } catch (err) {}
    };
...
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'key', [_dec3], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
...
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'writeToDom', [_dec5], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
