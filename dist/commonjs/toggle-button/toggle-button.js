...
var Ui5ToggleButton = exports.Ui5ToggleButton = (_dec = (0, _aureliaTemplating.customElement)('ui5-toggle-button'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaFramework.computedFrom)('_togglebutton'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Button) {
    ...
    function Ui5ToggleButton(element) {
        ...
        _initDefineProp(_this, 'pressed', _descriptor2, _this);
        ...
        if ($(this.element).closest("[ui5-container]").length > 0) {
            ...
            if (!this._parent.UIElement || this._parent.UIElement.sId != this._togglebutton.sId) {
                ...
                if (this.element.previousElementSibling && this.element.previousElementSibling.au) {
                    ...
                    this._relation = this._parent.addChild(this._togglebutton, this.element, prevSibling);
                } else this._relation = this._parent.addChild(this._togglebutton, this.element);
                this.attributeManager.addAttributes({ "ui5-container": '' });
            }
        } else {
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'customdata') {
                    var _index = null;if (afterElement) _index = this._togglebutton.indexOfCustomData(afterElement);if (_index) this._togglebutton.insertCustomData(child, _index + 1);else this._togglebutton.addCustomData(child, 0);return elem.localName;
                }
                if (elem.localName == 'layoutdata') {
                    this._togglebutton.setLayoutData(child);return elem.localName;
                }
                if (elem.localName == 'dependents') {
                    var _index = null;if (afterElement) _index = this._togglebutton.indexOfDependent(afterElement);if (_index) this._togglebutton.insertDependent(child, _index + 1);else this._togglebutton.addDependent(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
...
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, 'pressed', [_dec3], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
...
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'iconFirst', [_dec9], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'activeIcon', [_dec10], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
...
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'textDirection', [_dec12], {
    enumerable: true,
    initializer: function initializer() {
        return 'Inherit';
    }
