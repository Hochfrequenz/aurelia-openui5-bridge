...
var Ui5ListItemBase = exports.Ui5ListItemBase = (_dec = (0, _aureliaTemplating.customElement)('ui5-list-item-base'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaFramework.computedFrom)('_listitembase'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
    ...
    Ui5ListItemBase.prototype.attached = function attached() {
        ...
        if (this.ui5Class) this._listitembase.addStyleClass(this.ui5Class);
        if (this.ui5Tooltip) this._listitembase.setTooltip(this.ui5Tooltip);
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'dragdropconfig') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._listitembase.insertDragDropConfig(child, _index);else this._listitembase.addDragDropConfig(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
    ...
    Ui5ListItemBase.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
        try {
            ...
            if (relation == 'dragdropconfig') {
                this._listitembase.removeDragDropConfig(child);
            }
        } catch (err) {}
    };
    ...
    Ui5ListItemBase.prototype.highlightTextChanged = function highlightTextChanged(newValue) {
        if (newValue != null && newValue != undefined && this._listitembase !== null) {
            this._listitembase.setHighlightText(newValue);
        }
    };

    Ui5ListItemBase.prototype.navigatedChanged = function navigatedChanged(newValue) {
        if (newValue != null && newValue != undefined && this._listitembase !== null) {
            this._listitembase.setNavigated((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
