...
var Ui5Icon = exports.Ui5Icon = (_dec = (0, _aureliaTemplating.customElement)('ui5-icon'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaTemplating.bindable)(), _dec27 = (0, _aureliaTemplating.bindable)(), _dec28 = (0, _aureliaTemplating.bindable)(), _dec29 = (0, _aureliaTemplating.bindable)(), _dec30 = (0, _aureliaFramework.computedFrom)('_icon'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
    ...
    function Ui5Icon(element) {
        ...
        _initDefineProp(_this, 'src', _descriptor5, _this);

        _initDefineProp(_this, 'size', _descriptor6, _this);

        _initDefineProp(_this, 'color', _descriptor7, _this);

        _initDefineProp(_this, 'hoverColor', _descriptor8, _this);

        _initDefineProp(_this, 'activeColor', _descriptor9, _this);

        _initDefineProp(_this, 'width', _descriptor10, _this);

        _initDefineProp(_this, 'height', _descriptor11, _this);

        _initDefineProp(_this, 'backgroundColor', _descriptor12, _this);

        _initDefineProp(_this, 'hoverBackgroundColor', _descriptor13, _this);

        _initDefineProp(_this, 'activeBackgroundColor', _descriptor14, _this);

        _initDefineProp(_this, 'decorative', _descriptor15, _this);

        _initDefineProp(_this, 'useIconTooltip', _descriptor16, _this);

        _initDefineProp(_this, 'alt', _descriptor17, _this);

        _initDefineProp(_this, 'noTabStop', _descriptor18, _this);

        _initDefineProp(_this, 'press', _descriptor19, _this);

        _initDefineProp(_this, 'blocked', _descriptor20, _this);
    ...
    Ui5Icon.prototype.fillProperties = function fillProperties(params) {
        ...
        params.decorative = (0, _attributes.getBooleanFromAttributeValue)(this.decorative);
        params.useIconTooltip = (0, _attributes.getBooleanFromAttributeValue)(this.useIconTooltip);
        params.alt = this.alt;
    ...
    Ui5Icon.prototype.attached = function attached() {
        ...
        if (this.ui5Class) this._icon.addStyleClass(this.ui5Class);
        if (this.ui5Tooltip) this._icon.setTooltip(this.ui5Tooltip);
        ...
        try {
            if ($(this.element).closest("[ui5-container]").length > 0) {
                if (this._parent && this._relation) {
                    if (this._icon) this._parent.removeChildByRelation(this._icon, this._relation);
                }
            } else {
                this._icon.destroy();
            }
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'customdata') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._icon.insertCustomData(child, _index);else this._icon.addCustomData(child, 0);return elem.localName;
                }
                if (elem.localName == 'layoutdata') {
                    this._icon.setLayoutData(child);return elem.localName;
                }
                if (elem.localName == 'dependents') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._icon.insertDependent(child, _index);else this._icon.addDependent(child, 0);return elem.localName;
                }
                if (elem.localName == 'dragdropconfig') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._icon.insertDragDropConfig(child, _index);else this._icon.addDragDropConfig(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
    ...
    Ui5Icon.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
        try {
            ...
            if (relation == 'dragdropconfig') {
                this._icon.removeDragDropConfig(child);
            }
        } catch (err) {}
    };
    ...
    Ui5Icon.prototype.blockedChanged = function blockedChanged(newValue) {
        if (this._icon !== null) {
            this._icon.setBlocked((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };

    Ui5Icon.prototype.busyChanged = function busyChanged(newValue) {
        if (this._icon !== null) {
            this._icon.setBusy((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
    ...
    Ui5Icon.prototype.busyIndicatorSizeChanged = function busyIndicatorSizeChanged(newValue) {
        if (this._icon !== null) {
            this._icon.setBusyIndicatorSize(newValue);
        }
    };

    Ui5Icon.prototype.visibleChanged = function visibleChanged(newValue) {
        if (this._icon !== null) {
            this._icon.setVisible((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
...
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'src', [_dec3], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'size', [_dec4], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'color', [_dec5], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'hoverColor', [_dec6], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'activeColor', [_dec7], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
...
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'height', [_dec9], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'backgroundColor', [_dec10], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'hoverBackgroundColor', [_dec11], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, 'activeBackgroundColor', [_dec12], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, 'decorative', [_dec13], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, 'useIconTooltip', [_dec14], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, 'alt', [_dec15], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, 'noTabStop', [_dec16], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
...
}), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, 'blocked', [_dec18], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, 'busy', [_dec19], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, 'busyIndicatorDelay', [_dec20], {
    enumerable: true,
    initializer: function initializer() {
        return 1000;
    }
}), _descriptor23 = _applyDecoratedDescriptor(_class2.prototype, 'busyIndicatorSize', [_dec21], {
    enumerable: true,
    initializer: function initializer() {
        return 'Medium';
    }
}), _descriptor24 = _applyDecoratedDescriptor(_class2.prototype, 'visible', [_dec22], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor25 = _applyDecoratedDescriptor(_class2.prototype, 'fieldGroupIds', [_dec23], {
    enumerable: true,
    initializer: function initializer() {
        return '[]';
    }
}), _descriptor26 = _applyDecoratedDescriptor(_class2.prototype, 'validateFieldGroup', [_dec24], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor27 = _applyDecoratedDescriptor(_class2.prototype, 'validationSuccess', [_dec25], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor28 = _applyDecoratedDescriptor(_class2.prototype, 'validationError', [_dec26], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor29 = _applyDecoratedDescriptor(_class2.prototype, 'parseError', [_dec27], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor30 = _applyDecoratedDescriptor(_class2.prototype, 'formatError', [_dec28], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor31 = _applyDecoratedDescriptor(_class2.prototype, 'modelContextChange', [_dec29], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
