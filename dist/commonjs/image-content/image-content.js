...
var Ui5ImageContent = exports.Ui5ImageContent = (_dec = (0, _aureliaTemplating.customElement)('ui5-image-content'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaFramework.computedFrom)('_imagecontent'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
    ...
    function Ui5ImageContent(element) {
        ...
        _initDefineProp(_this, 'blocked', _descriptor8, _this);
    ...
    Ui5ImageContent.prototype.attached = function attached() {
        ...
        if (this.ui5Class) this._imagecontent.addStyleClass(this.ui5Class);
        if (this.ui5Tooltip) this._imagecontent.setTooltip(this.ui5Tooltip);
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'dragdropconfig') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._imagecontent.insertDragDropConfig(child, _index);else this._imagecontent.addDragDropConfig(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
    ...
    Ui5ImageContent.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
        try {
            ...
            if (relation == 'dragdropconfig') {
                this._imagecontent.removeDragDropConfig(child);
            }
        } catch (err) {}
    };
    ...
    Ui5ImageContent.prototype.blockedChanged = function blockedChanged(newValue) {
        if (this._imagecontent !== null) {
            this._imagecontent.setBlocked((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
...
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'press', [_dec5], {
    enumerable: true,
    initializer: function initializer() {
        return this.defaultFunc;
    }
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'blocked', [_dec6], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
