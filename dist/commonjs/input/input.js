...
var Ui5Input = exports.Ui5Input = (_dec = (0, _aureliaTemplating.customElement)('ui5-input'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaTemplating.bindable)(), _dec27 = (0, _aureliaTemplating.bindable)(), _dec28 = (0, _aureliaTemplating.bindable)(), _dec29 = (0, _aureliaTemplating.bindable)(), _dec30 = (0, _aureliaTemplating.bindable)(), _dec31 = (0, _aureliaTemplating.bindable)(), _dec32 = (0, _aureliaTemplating.bindable)(), _dec33 = (0, _aureliaTemplating.bindable)(), _dec34 = (0, _aureliaTemplating.bindable)(), _dec35 = (0, _aureliaTemplating.bindable)(), _dec36 = (0, _aureliaTemplating.bindable)(), _dec37 = (0, _aureliaTemplating.bindable)(), _dec38 = (0, _aureliaTemplating.bindable)(), _dec39 = (0, _aureliaTemplating.bindable)(), _dec40 = (0, _aureliaTemplating.bindable)(), _dec41 = (0, _aureliaTemplating.bindable)(), _dec42 = (0, _aureliaTemplating.bindable)(), _dec43 = (0, _aureliaTemplating.bindable)(), _dec44 = (0, _aureliaTemplating.bindable)(), _dec45 = (0, _aureliaTemplating.bindable)(), _dec46 = (0, _aureliaTemplating.bindable)(), _dec47 = (0, _aureliaTemplating.bindable)(), _dec48 = (0, _aureliaTemplating.bindable)(), _dec49 = (0, _aureliaTemplating.bindable)(), _dec50 = (0, _aureliaFramework.computedFrom)('_input'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5InputBase) {
    ...
    function Ui5Input(element) {
        ...
        _initDefineProp(_this, 'showValueHelp', _descriptor7, _this);

        _initDefineProp(_this, 'showSuggestion', _descriptor8, _this);

        _initDefineProp(_this, 'valueHelpOnly', _descriptor9, _this);

        _initDefineProp(_this, 'filterSuggests', _descriptor10, _this);

        _initDefineProp(_this, 'maxSuggestionWidth', _descriptor11, _this);

        _initDefineProp(_this, 'startSuggestion', _descriptor12, _this);

        _initDefineProp(_this, 'showTableSuggestionValueHelp', _descriptor13, _this);

        _initDefineProp(_this, 'description', _descriptor14, _this);

        _initDefineProp(_this, 'fieldWidth', _descriptor15, _this);

        _initDefineProp(_this, 'valueLiveUpdate', _descriptor16, _this);

        _initDefineProp(_this, 'selectedKey', _descriptor17, _this);

        _initDefineProp(_this, 'textFormatMode', _descriptor18, _this);

        _initDefineProp(_this, 'textFormatter', _descriptor19, _this);

        _initDefineProp(_this, 'suggestionRowValidator', _descriptor20, _this);
    ...
    Ui5Input.prototype.fillProperties = function fillProperties(params) {
        ...
        params.autocomplete = (0, _attributes.getBooleanFromAttributeValue)(this.autocomplete);
    ...
    Ui5Input.prototype.attached = function attached() {
        ...
        if (this.ui5Class) this._input.addStyleClass(this.ui5Class);
        if (this.ui5Tooltip) this._input.setTooltip(this.ui5Tooltip);
        ...
        for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
            ...
            try {
                ...
                if (elem.localName == 'dragdropconfig') {
                    var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._input.insertDragDropConfig(child, _index);else this._input.addDragDropConfig(child, 0);return elem.localName;
                }
            } catch (err) {}
        }
    };
    ...
    Ui5Input.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
        try {
            ...
            if (relation == 'dragdropconfig') {
                this._input.removeDragDropConfig(child);
            }
        } catch (err) {}
    };
    ...
    Ui5Input.prototype.autocompleteChanged = function autocompleteChanged(newValue) {
        if (newValue != null && newValue != undefined && this._input !== null) {
            this._input.setAutocomplete((0, _attributes.getBooleanFromAttributeValue)(newValue));
        }
    };
...
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'maxLength', [_dec4], {
    enumerable: true,
    initializer: function initializer() {
        return 0;
    }
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'showValueHelp', [_dec5], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'showSuggestion', [_dec6], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'valueHelpOnly', [_dec7], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'filterSuggests', [_dec8], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'maxSuggestionWidth', [_dec9], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'startSuggestion', [_dec10], {
    enumerable: true,
    initializer: function initializer() {
        return 1;
    }
}), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'showTableSuggestionValueHelp', [_dec11], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
}), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, 'description', [_dec12], {
    enumerable: true,
    initializer: function initializer() {
        return null;
    }
}), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, 'fieldWidth', [_dec13], {
    enumerable: true,
    initializer: function initializer() {
        return '50%';
    }
}), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, 'valueLiveUpdate', [_dec14], {
    enumerable: true,
    initializer: function initializer() {
        return false;
    }
}), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, 'selectedKey', [_dec15], {
    enumerable: true,
    initializer: function initializer() {
        return '';
    }
}), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, 'textFormatMode', [_dec16], {
    enumerable: true,
    initializer: function initializer() {
        return 'Value';
    }
}), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, 'textFormatter', [_dec17], {
    enumerable: true,
    initializer: function initializer() {
        return '';
    }
}), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, 'suggestionRowValidator', [_dec18], {
    enumerable: true,
    initializer: function initializer() {
        return '';
    }
}), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, 'enableSuggestionsHighlighting', [_dec19], {
    enumerable: true,
    initializer: function initializer() {
        return true;
    }
