define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../tree-item-base/tree-item-base'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _treeItemBase) {
    'use strict';
    ...
    var Ui5CustomTreeItem = exports.Ui5CustomTreeItem = (_dec = (0, _aureliaTemplating.customElement)('ui5-custom-tree-item'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaFramework.computedFrom)('_customtreeitem'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5TreeItemBase) {
            ...
            if ($(this.element).closest("[ui5-container]").length > 0) {
                ...
                if (!this._parent.UIElement || this._parent.UIElement.sId != this._customtreeitem.sId) {
                    ...
                    if (this.element.previousElementSibling && this.element.previousElementSibling.au) {
                        ...
                        this._relation = this._parent.addChild(this._customtreeitem, this.element, prevSibling);
                    } else this._relation = this._parent.addChild(this._customtreeitem, this.element);
                    this.attributeManager.addAttributes({ "ui5-container": '' });
                }
            } else {
            ...
            for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                ...
                try {
                    if (elem.localName == 'content') {
                        var _index = null;if (afterElement) _index = this._customtreeitem.indexOfContent(afterElement);if (_index) this._customtreeitem.insertContent(child, _index + 1);else this._customtreeitem.addContent(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'tooltip') {
                        this._customtreeitem.setTooltip(child);return elem.localName;
                    }
                    if (elem.localName == 'customdata') {
                        var _index = null;if (afterElement) _index = this._customtreeitem.indexOfCustomData(afterElement);if (_index) this._customtreeitem.insertCustomData(child, _index + 1);else this._customtreeitem.addCustomData(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'layoutdata') {
                        this._customtreeitem.setLayoutData(child);return elem.localName;
                    }
                    if (elem.localName == 'dependents') {
                        var _index = null;if (afterElement) _index = this._customtreeitem.indexOfDependent(afterElement);if (_index) this._customtreeitem.insertDependent(child, _index + 1);else this._customtreeitem.addDependent(child, 0);return elem.localName;
                    }
                } catch (err) {}
            }
        };
        ...
        Ui5CustomTreeItem.prototype.visibleChanged = function visibleChanged(newValue) {
            if (this._customtreeitem !== null) {
                this._customtreeitem.setVisible((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };

        Ui5CustomTreeItem.prototype.unreadChanged = function unreadChanged(newValue) {
            if (this._customtreeitem !== null) {
                this._customtreeitem.setUnread((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };

        Ui5CustomTreeItem.prototype.selectedChanged = function selectedChanged(newValue) {
            if (this._customtreeitem !== null) {
                this._customtreeitem.setSelected((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5CustomTreeItem.prototype.busyChanged = function busyChanged(newValue) {
            if (this._customtreeitem !== null) {
                this._customtreeitem.setBusy((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
    ...
    }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'busyIndicatorSize', [_dec13], {
        enumerable: true,
        initializer: function initializer() {
            return 'Medium';
        }
