define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _control) {
    ...
    var Ui5DynamicPageHeader = exports.Ui5DynamicPageHeader = (_dec = (0, _aureliaTemplating.customElement)('ui5-dynamic-page-header'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaFramework.computedFrom)('_dynamicpageheader'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
        ...
        function Ui5DynamicPageHeader(element) {
            ...
            _initDefineProp(_this, 'pinnable', _descriptor5, _this);
        ...
        Ui5DynamicPageHeader.prototype.attached = function attached() {
            ...
            if (this.ui5Class) this._dynamicpageheader.addStyleClass(this.ui5Class);
            if (this.ui5Tooltip) this._dynamicpageheader.setTooltip(this.ui5Tooltip);
            ...
            if ($(this.element).closest("[ui5-container]").length > 0) {
                ...
                if (this._dynamicpageheader.placeAt) this._dynamicpageheader.placeAt(this.element.parentElement);
                this.attributeManager.addAttributes({ "ui5-container": '' });
            ...
            try {
                if ($(this.element).closest("[ui5-container]").length > 0) {
                    if (this._parent && this._relation) {
                        if (this._dynamicpageheader) this._parent.removeChildByRelation(this._dynamicpageheader, this._relation);
                    }
                } else {
            ...
            for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                ...
                try {
                    if (elem.localName == 'content') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._dynamicpageheader.insertContent(child, _index);else this._dynamicpageheader.addContent(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'tooltip') {
                        this._dynamicpageheader.setTooltip(child);return elem.localName;
                    }
                    if (elem.localName == 'customdata') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._dynamicpageheader.insertCustomData(child, _index);else this._dynamicpageheader.addCustomData(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'layoutdata') {
                        this._dynamicpageheader.setLayoutData(child);return elem.localName;
                    }
                    if (elem.localName == 'dependents') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._dynamicpageheader.insertDependent(child, _index);else this._dynamicpageheader.addDependent(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'dragdropconfig') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._dynamicpageheader.insertDragDropConfig(child, _index);else this._dynamicpageheader.addDragDropConfig(child, 0);return elem.localName;
                    }
                } catch (err) {}
            }
        };
        ...
        Ui5DynamicPageHeader.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
            try {
                ...
                if (relation == 'dragdropconfig') {
                    this._dynamicpageheader.removeDragDropConfig(child);
                }
            } catch (err) {}
        };

        Ui5DynamicPageHeader.prototype.pinnableChanged = function pinnableChanged(newValue) {
            if (newValue != null && newValue != undefined && this._dynamicpageheader !== null) {
                this._dynamicpageheader.setPinnable((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };

        Ui5DynamicPageHeader.prototype.backgroundDesignChanged = function backgroundDesignChanged(newValue) {
            if (newValue != null && newValue != undefined && this._dynamicpageheader !== null) {
                this._dynamicpageheader.setBackgroundDesign(newValue);
            }
        };

        Ui5DynamicPageHeader.prototype.blockedChanged = function blockedChanged(newValue) {
            if (this._dynamicpageheader !== null) {
                this._dynamicpageheader.setBlocked((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };

        Ui5DynamicPageHeader.prototype.busyChanged = function busyChanged(newValue) {
            if (this._dynamicpageheader !== null) {
                this._dynamicpageheader.setBusy((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };

        Ui5DynamicPageHeader.prototype.busyIndicatorDelayChanged = function busyIndicatorDelayChanged(newValue) {
            if (this._dynamicpageheader !== null) {
                this._dynamicpageheader.setBusyIndicatorDelay(newValue);
            }
        };

        Ui5DynamicPageHeader.prototype.busyIndicatorSizeChanged = function busyIndicatorSizeChanged(newValue) {
            if (this._dynamicpageheader !== null) {
                this._dynamicpageheader.setBusyIndicatorSize(newValue);
            }
        };

        Ui5DynamicPageHeader.prototype.visibleChanged = function visibleChanged(newValue) {
            if (this._dynamicpageheader !== null) {
                this._dynamicpageheader.setVisible((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };

        Ui5DynamicPageHeader.prototype.fieldGroupIdsChanged = function fieldGroupIdsChanged(newValue) {
            if (this._dynamicpageheader !== null) {
                this._dynamicpageheader.setFieldGroupIds(newValue);
            }
        };
        ...
        _createClass(Ui5DynamicPageHeader, [{
            key: 'UIElement',
            get: function get() {
    ...
    }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'pinnable', [_dec3], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
