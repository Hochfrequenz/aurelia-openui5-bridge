define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _control) {
    ...
    var Ui5SearchField = exports.Ui5SearchField = (_dec = (0, _aureliaTemplating.customElement)('ui5-search-field'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaFramework.computedFrom)('_searchfield'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
        ...
        function Ui5SearchField(element) {
            ...
            _initDefineProp(_this, 'showMagnifier', _descriptor8, _this);
            ...
            _initDefineProp(_this, 'selectOnFocus', _descriptor13, _this);

            _initDefineProp(_this, 'search', _descriptor14, _this);

            _initDefineProp(_this, 'liveChange', _descriptor15, _this);

            _initDefineProp(_this, 'suggest', _descriptor16, _this);
        ...
        Ui5SearchField.prototype.fillProperties = function fillProperties(params) {
            ...
            params.showMagnifier = (0, _attributes.getBooleanFromAttributeValue)(this.showMagnifier);
            ...
            params.selectOnFocus = (0, _attributes.getBooleanFromAttributeValue)(this.selectOnFocus);
        };
        ...
        Ui5SearchField.prototype.showMagnifierChanged = function showMagnifierChanged(newValue) {
            if (this._searchfield !== null) {
                this._searchfield.setShowMagnifier((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5SearchField.prototype.selectOnFocusChanged = function selectOnFocusChanged(newValue) {
            if (this._searchfield !== null) {
                this._searchfield.setSelectOnFocus((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
    ...
    }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'showMagnifier', [_dec9], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
    }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'showRefreshButton', [_dec10], {
        enumerable: true,
        initializer: function initializer() {
            return false;
        }
    }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'refreshButtonTooltip', [_dec11], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'showSearchButton', [_dec12], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
    }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'enableSuggestions', [_dec13], {
        enumerable: true,
        initializer: function initializer() {
            return false;
        }
    }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'selectOnFocus', [_dec14], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
    ...
    }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, 'liveChange', [_dec16], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
    }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, 'suggest', [_dec17], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
