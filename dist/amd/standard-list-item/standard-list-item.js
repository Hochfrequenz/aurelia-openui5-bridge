define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../list-item-base/list-item-base'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _listItemBase) {
    ...
    var Ui5StandardListItem = exports.Ui5StandardListItem = (_dec = (0, _aureliaTemplating.customElement)('ui5-standard-list-item'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaTemplating.bindable)(), _dec27 = (0, _aureliaTemplating.bindable)(), _dec28 = (0, _aureliaTemplating.bindable)(), _dec29 = (0, _aureliaTemplating.bindable)(), _dec30 = (0, _aureliaTemplating.bindable)(), _dec31 = (0, _aureliaTemplating.bindable)(), _dec32 = (0, _aureliaTemplating.bindable)(), _dec33 = (0, _aureliaFramework.computedFrom)('_standardlistitem'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5ListItemBase) {
        ...
        function Ui5StandardListItem(element) {
            ...
            _initDefineProp(_this, 'iconInset', _descriptor5, _this);

            _initDefineProp(_this, 'iconDensityAware', _descriptor6, _this);

            _initDefineProp(_this, 'activeIcon', _descriptor7, _this);

            _initDefineProp(_this, 'info', _descriptor8, _this);

            _initDefineProp(_this, 'infoState', _descriptor9, _this);

            _initDefineProp(_this, 'adaptTitleSize', _descriptor10, _this);

            _initDefineProp(_this, 'titleTextDirection', _descriptor11, _this);

            _initDefineProp(_this, 'infoTextDirection', _descriptor12, _this);

            _initDefineProp(_this, 'type', _descriptor13, _this);

            _initDefineProp(_this, 'visible', _descriptor14, _this);

            _initDefineProp(_this, 'unread', _descriptor15, _this);

            _initDefineProp(_this, 'selected', _descriptor16, _this);

            _initDefineProp(_this, 'counter', _descriptor17, _this);

            _initDefineProp(_this, 'highlight', _descriptor18, _this);

            _initDefineProp(_this, 'press', _descriptor19, _this);

            _initDefineProp(_this, 'detailPress', _descriptor20, _this);
            ...
            if ($(this.element).closest("[ui5-container]").length > 0) {
                ...
                if (!this._parent.UIElement || this._parent.UIElement.sId != this._standardlistitem.sId) {
                    ...
                    if (this.element.previousElementSibling && this.element.previousElementSibling.au) {
                        ...
                        this._relation = this._parent.addChild(this._standardlistitem, this.element, prevSibling);
                    } else this._relation = this._parent.addChild(this._standardlistitem, this.element);
                    this.attributeManager.addAttributes({ "ui5-container": '' });
                }
            } else {
            ...
            for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                ...
                try {
                    ...
                    if (elem.localName == 'customdata') {
                        var _index = null;if (afterElement) _index = this._standardlistitem.indexOfCustomData(afterElement);if (_index) this._standardlistitem.insertCustomData(child, _index + 1);else this._standardlistitem.addCustomData(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'layoutdata') {
                        this._standardlistitem.setLayoutData(child);return elem.localName;
                    }
                    if (elem.localName == 'dependents') {
                        var _index = null;if (afterElement) _index = this._standardlistitem.indexOfDependent(afterElement);if (_index) this._standardlistitem.insertDependent(child, _index + 1);else this._standardlistitem.addDependent(child, 0);return elem.localName;
                    }
                } catch (err) {}
            }
        };
    ...
    }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'iconInset', [_dec6], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
    }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'iconDensityAware', [_dec7], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
    }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'activeIcon', [_dec8], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'info', [_dec9], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'infoState', [_dec10], {
        enumerable: true,
        initializer: function initializer() {
            return 'None';
        }
    }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'adaptTitleSize', [_dec11], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
    }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'titleTextDirection', [_dec12], {
        enumerable: true,
        initializer: function initializer() {
            return 'Inherit';
        }
    }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'infoTextDirection', [_dec13], {
        enumerable: true,
        initializer: function initializer() {
            return 'Inherit';
        }
    ...
    }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, 'unread', [_dec16], {
        enumerable: true,
        initializer: function initializer() {
            return false;
        }
    }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, 'selected', [_dec17], {
        enumerable: true,
        initializer: function initializer() {
            return false;
        }
    }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, 'counter', [_dec18], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, 'highlight', [_dec19], {
        enumerable: true,
        initializer: function initializer() {
            return 'None';
        }
    }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, 'press', [_dec20], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
    }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, 'detailPress', [_dec21], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
    }), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, 'busy', [_dec22], {
        enumerable: true,
        initializer: function initializer() {
            return false;
        }
    }), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, 'busyIndicatorDelay', [_dec23], {
        enumerable: true,
        initializer: function initializer() {
            return 1000;
        }
    }), _descriptor23 = _applyDecoratedDescriptor(_class2.prototype, 'busyIndicatorSize', [_dec24], {
        enumerable: true,
        initializer: function initializer() {
            return 'Medium';
        }
    ...
    }), _descriptor25 = _applyDecoratedDescriptor(_class2.prototype, 'fieldGroupIds', [_dec26], {
        enumerable: true,
        initializer: function initializer() {
            return '[]';
        }
    }), _descriptor26 = _applyDecoratedDescriptor(_class2.prototype, 'validateFieldGroup', [_dec27], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
    }), _descriptor27 = _applyDecoratedDescriptor(_class2.prototype, 'validationSuccess', [_dec28], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
    }), _descriptor28 = _applyDecoratedDescriptor(_class2.prototype, 'validationError', [_dec29], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
    }), _descriptor29 = _applyDecoratedDescriptor(_class2.prototype, 'parseError', [_dec30], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
    }), _descriptor30 = _applyDecoratedDescriptor(_class2.prototype, 'formatError', [_dec31], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
    }), _descriptor31 = _applyDecoratedDescriptor(_class2.prototype, 'modelContextChange', [_dec32], {
        enumerable: true,
        initializer: function initializer() {
            return this.defaultFunc;
        }
