define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _control) {
    ...
    var Ui5TileContent = exports.Ui5TileContent = (_dec = (0, _aureliaTemplating.customElement)('ui5-tile-content'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaFramework.computedFrom)('_tilecontent'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
        ...
        function Ui5TileContent(element) {
            ...
            _initDefineProp(_this, 'footerColor', _descriptor4, _this);
        ...
        Ui5TileContent.prototype.fillProperties = function fillProperties(params) {
            ...
            params.disabled = (0, _attributes.getBooleanFromAttributeValue)(this.disabled);
        ...
        Ui5TileContent.prototype.disabledChanged = function disabledChanged(newValue) {
            if (this._tilecontent !== null) {
                this._tilecontent.setDisabled((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5TileContent.prototype.busyChanged = function busyChanged(newValue) {
            if (this._tilecontent !== null) {
                this._tilecontent.setBusy((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5TileContent.prototype.visibleChanged = function visibleChanged(newValue) {
            if (this._tilecontent !== null) {
                this._tilecontent.setVisible((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
    ...
    }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, 'footer', [_dec3], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, 'footerColor', [_dec4], {
        enumerable: true,
        initializer: function initializer() {
            return 'Neutral';
        }
    }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'unit', [_dec5], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
