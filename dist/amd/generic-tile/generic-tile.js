define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _control) {
    ...
    var Ui5GenericTile = exports.Ui5GenericTile = (_dec = (0, _aureliaTemplating.customElement)('ui5-generic-tile'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaFramework.computedFrom)('_generictile'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
        ...
        function Ui5GenericTile(element) {
            ...
            _initDefineProp(_this, 'backgroundImage', _descriptor7, _this);

            _initDefineProp(_this, 'headerImage', _descriptor8, _this);

            _initDefineProp(_this, 'state', _descriptor9, _this);

            _initDefineProp(_this, 'imageDescription', _descriptor10, _this);

            _initDefineProp(_this, 'scope', _descriptor11, _this);

            _initDefineProp(_this, 'ariaLabel', _descriptor12, _this);
            ...
            for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                ...
                try {
                    ...
                    if (elem.localName == 'customdata') {
                        var _index = null;if (afterElement) _index = this._generictile.indexOfCustomData(afterElement);if (_index) this._generictile.insertCustomData(child, _index + 1);else this._generictile.addCustomData(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'layoutdata') {
                        this._generictile.setLayoutData(child);return elem.localName;
                    }
                    if (elem.localName == 'dependents') {
                        var _index = null;if (afterElement) _index = this._generictile.indexOfDependent(afterElement);if (_index) this._generictile.insertDependent(child, _index + 1);else this._generictile.addDependent(child, 0);return elem.localName;
                    }
                } catch (err) {}
            }
        };
    ...
    }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'backgroundImage', [_dec8], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'headerImage', [_dec9], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'state', [_dec10], {
        enumerable: true,
        initializer: function initializer() {
            return 'Loaded';
        }
    }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'imageDescription', [_dec11], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'scope', [_dec12], {
        enumerable: true,
        initializer: function initializer() {
            return 'Display';
        }
    }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'ariaLabel', [_dec13], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
