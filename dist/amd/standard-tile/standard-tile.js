define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../tile/tile'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _tile) {
    'use strict';
    ...
    var Ui5StandardTile = exports.Ui5StandardTile = (_dec = (0, _aureliaTemplating.customElement)('ui5-standard-tile'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaFramework.computedFrom)('_standardtile'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Tile) {
        ...
        function Ui5StandardTile(element) {
            ...
            _initDefineProp(_this, 'info', _descriptor6, _this);

            _initDefineProp(_this, 'icon', _descriptor7, _this);

            _initDefineProp(_this, 'activeIcon', _descriptor8, _this);

            _initDefineProp(_this, 'number', _descriptor9, _this);

            _initDefineProp(_this, 'numberUnit', _descriptor10, _this);

            _initDefineProp(_this, 'infoState', _descriptor11, _this);

            _initDefineProp(_this, 'type', _descriptor12, _this);

            _initDefineProp(_this, 'iconDensityAware', _descriptor13, _this);

            _initDefineProp(_this, 'removable', _descriptor14, _this);
        ...
        Ui5StandardTile.prototype.attached = function attached() {
            ...
            if (this.ui5Class) this._standardtile.addStyleClass(this.ui5Class);
            if (this.ui5Tooltip) this._standardtile.setTooltip(this.ui5Tooltip);
            ...
            try {
                if ($(this.element).closest("[ui5-container]").length > 0) {
                    if (this._parent && this._relation) {
                        if (this._standardtile) this._parent.removeChildByRelation(this._standardtile, this._relation);
                    }
                } else {
            ...
            for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                ...
                try {
                    ...
                    if (elem.localName == 'customdata') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._standardtile.insertCustomData(child, _index);else this._standardtile.addCustomData(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'layoutdata') {
                        this._standardtile.setLayoutData(child);return elem.localName;
                    }
                    if (elem.localName == 'dependents') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._standardtile.insertDependent(child, _index);else this._standardtile.addDependent(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'dragdropconfig') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._standardtile.insertDragDropConfig(child, _index);else this._standardtile.addDragDropConfig(child, 0);return elem.localName;
                    }
                } catch (err) {}
            }
        };
        ...
        Ui5StandardTile.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
            try {
                ...
                if (relation == 'dragdropconfig') {
                    this._standardtile.removeDragDropConfig(child);
                }
            } catch (err) {}
        };
        ...
        Ui5StandardTile.prototype.blockedChanged = function blockedChanged(newValue) {
            if (this._standardtile !== null) {
                this._standardtile.setBlocked((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5StandardTile.prototype.busyIndicatorSizeChanged = function busyIndicatorSizeChanged(newValue) {
            if (this._standardtile !== null) {
                this._standardtile.setBusyIndicatorSize(newValue);
            }
        };
    ...
    }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'info', [_dec4], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    ...
    }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'activeIcon', [_dec6], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'number', [_dec7], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'numberUnit', [_dec8], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, 'infoState', [_dec9], {
        enumerable: true,
        initializer: function initializer() {
            return 'None';
        }
    ...
    }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, 'removable', [_dec12], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
