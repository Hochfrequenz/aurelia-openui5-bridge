define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../element/element'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _element) {
    ...
    exports.Ui5gridTableColumn = undefined;
    ...
    var Ui5gridTableColumn = exports.Ui5gridTableColumn = (_dec = (0, _aureliaTemplating.customElement)('ui5-grid-table-column'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaTemplating.bindable)(), _dec27 = (0, _aureliaTemplating.bindable)(), _dec28 = (0, _aureliaTemplating.bindable)(), _dec29 = (0, _aureliaFramework.computedFrom)('_gridtablecolumn'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Element) {
        ...
        Ui5gridTableColumn.prototype.fillProperties = function fillProperties(params) {
            ...
            params.sorted = (0, _attributes.getBooleanFromAttributeValue)(this.sorted);
            params.sortOrder = this.sortOrder;
            params.sortProperty = this.sortProperty;
            params.filtered = (0, _attributes.getBooleanFromAttributeValue)(this.filtered);
            ...
            params.grouped = (0, _attributes.getBooleanFromAttributeValue)(this.grouped);
            params.visible = (0, _attributes.getBooleanFromAttributeValue)(this.visible);
            params.name = this.name;
            params.showFilterMenuEntry = (0, _attributes.getBooleanFromAttributeValue)(this.showFilterMenuEntry);
            params.showSortMenuEntry = (0, _attributes.getBooleanFromAttributeValue)(this.showSortMenuEntry);
            params.headerSpan = this.headerSpan;
            params.autoResizable = (0, _attributes.getBooleanFromAttributeValue)(this.autoResizable);
        ...
        Ui5gridTableColumn.prototype.resizableChanged = function resizableChanged(newValue) {
            if (this._gridtablecolumn !== null) {
                this._gridtablecolumn.setResizable((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5gridTableColumn.prototype.sortedChanged = function sortedChanged(newValue) {
            if (this._gridtablecolumn !== null) {
                this._gridtablecolumn.setSorted((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5gridTableColumn.prototype.filteredChanged = function filteredChanged(newValue) {
            if (this._gridtablecolumn !== null) {
                this._gridtablecolumn.setFiltered((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5gridTableColumn.prototype.groupedChanged = function groupedChanged(newValue) {
            if (this._gridtablecolumn !== null) {
                this._gridtablecolumn.setGrouped((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };

        Ui5gridTableColumn.prototype.visibleChanged = function visibleChanged(newValue) {
            if (this._gridtablecolumn !== null) {
                this._gridtablecolumn.setVisible((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5gridTableColumn.prototype.showFilterMenuEntryChanged = function showFilterMenuEntryChanged(newValue) {
            if (this._gridtablecolumn !== null) {
                this._gridtablecolumn.setShowFilterMenuEntry((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };

        Ui5gridTableColumn.prototype.showSortMenuEntryChanged = function showSortMenuEntryChanged(newValue) {
            if (this._gridtablecolumn !== null) {
                this._gridtablecolumn.setShowSortMenuEntry((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
        ...
        Ui5gridTableColumn.prototype.autoResizableChanged = function autoResizableChanged(newValue) {
            if (this._gridtablecolumn !== null) {
                this._gridtablecolumn.setAutoResizable((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
