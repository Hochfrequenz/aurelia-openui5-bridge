define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _control) {
    ...
    var Ui5VerticalLayout = exports.Ui5VerticalLayout = (_dec = (0, _aureliaTemplating.customElement)('ui5-vertical-layout'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaFramework.computedFrom)('_verticallayout'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
        ...
        Ui5VerticalLayout.prototype.attached = function attached() {
            ...
            if (this.ui5Class) this._verticallayout.addStyleClass(this.ui5Class);
            if (this.ui5Tooltip) this._verticallayout.setTooltip(this.ui5Tooltip);
            ...
            for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                ...
                try {
                    ...
                    if (elem.localName == 'dragdropconfig') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._verticallayout.insertDragDropConfig(child, _index);else this._verticallayout.addDragDropConfig(child, 0);return elem.localName;
                    }
                } catch (err) {}
            }
        };
        ...
        Ui5VerticalLayout.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
            try {
                ...
                if (relation == 'dragdropconfig') {
                    this._verticallayout.removeDragDropConfig(child);
                }
            } catch (err) {}
        };
        ...
        Ui5VerticalLayout.prototype.blockedChanged = function blockedChanged(newValue) {
            if (this._verticallayout !== null) {
                this._verticallayout.setBlocked((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
