define(['exports', 'aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (exports, _aureliaTemplating, _aureliaDependencyInjection, _aureliaFramework, _attributeManager, _attributes, _control) {
    ...
    var Ui5Shell = exports.Ui5Shell = (_dec = (0, _aureliaTemplating.customElement)('ui5-shell'), _dec2 = (0, _aureliaDependencyInjection.inject)(Element), _dec3 = (0, _aureliaTemplating.bindable)(), _dec4 = (0, _aureliaTemplating.bindable)(), _dec5 = (0, _aureliaTemplating.bindable)(), _dec6 = (0, _aureliaTemplating.bindable)(), _dec7 = (0, _aureliaTemplating.bindable)(), _dec8 = (0, _aureliaTemplating.bindable)(), _dec9 = (0, _aureliaTemplating.bindable)(), _dec10 = (0, _aureliaTemplating.bindable)(), _dec11 = (0, _aureliaTemplating.bindable)(), _dec12 = (0, _aureliaTemplating.bindable)(), _dec13 = (0, _aureliaTemplating.bindable)(), _dec14 = (0, _aureliaTemplating.bindable)(), _dec15 = (0, _aureliaTemplating.bindable)(), _dec16 = (0, _aureliaTemplating.bindable)(), _dec17 = (0, _aureliaTemplating.bindable)(), _dec18 = (0, _aureliaTemplating.bindable)(), _dec19 = (0, _aureliaTemplating.bindable)(), _dec20 = (0, _aureliaTemplating.bindable)(), _dec21 = (0, _aureliaTemplating.bindable)(), _dec22 = (0, _aureliaTemplating.bindable)(), _dec23 = (0, _aureliaTemplating.bindable)(), _dec24 = (0, _aureliaTemplating.bindable)(), _dec25 = (0, _aureliaTemplating.bindable)(), _dec26 = (0, _aureliaTemplating.bindable)(), _dec27 = (0, _aureliaFramework.computedFrom)('_shell'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
        ...
        function Ui5Shell(element) {
            ...
            _initDefineProp(_this, 'logo', _descriptor6, _this);

            _initDefineProp(_this, 'showLogout', _descriptor7, _this);

            _initDefineProp(_this, 'headerRightText', _descriptor8, _this);

            _initDefineProp(_this, 'appWidthLimited', _descriptor9, _this);
            ...
            _initDefineProp(_this, 'homeIcon', _descriptor14, _this);

            _initDefineProp(_this, 'titleLevel', _descriptor15, _this);

            _initDefineProp(_this, 'logout', _descriptor16, _this);
        ...
        Ui5Shell.prototype.attached = function attached() {
            ...
            if (this.ui5Class) this._shell.addStyleClass(this.ui5Class);
            if (this.ui5Tooltip) this._shell.setTooltip(this.ui5Tooltip);
            ...
            try {
                if ($(this.element).closest("[ui5-container]").length > 0) {
                    if (this._parent && this._relation) {
                        if (this._shell) this._parent.removeChildByRelation(this._shell, this._relation);
                    }
                } else {
                    this._shell.destroy();
                }
            ...
            for (var _iterator = path, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                ...
                try {
                    ...
                    if (elem.localName == 'customdata') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._shell.insertCustomData(child, _index);else this._shell.addCustomData(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'layoutdata') {
                        this._shell.setLayoutData(child);return elem.localName;
                    }
                    if (elem.localName == 'dependents') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._shell.insertDependent(child, _index);else this._shell.addDependent(child, 0);return elem.localName;
                    }
                    if (elem.localName == 'dragdropconfig') {
                        var _index = afterElement ? Math.floor(afterElement + 1) : null;if (_index) this._shell.insertDragDropConfig(child, _index);else this._shell.addDragDropConfig(child, 0);return elem.localName;
                    }
                } catch (err) {}
            }
        };
        ...
        Ui5Shell.prototype.removeChildByRelation = function removeChildByRelation(child, relation) {
            try {
                ...
                if (relation == 'dragdropconfig') {
                    this._shell.removeDragDropConfig(child);
                }
            } catch (err) {}
        };
        ...
        Ui5Shell.prototype.blockedChanged = function blockedChanged(newValue) {
            if (this._shell !== null) {
                this._shell.setBlocked((0, _attributes.getBooleanFromAttributeValue)(newValue));
            }
        };
    ...
    }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'logo', [_dec4], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'showLogout', [_dec5], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
    }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'headerRightText', [_dec6], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'appWidthLimited', [_dec7], {
        enumerable: true,
        initializer: function initializer() {
            return true;
        }
    ...
    }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, 'homeIcon', [_dec12], {
        enumerable: true,
        initializer: function initializer() {
            return null;
        }
    }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, 'titleLevel', [_dec13], {
        enumerable: true,
        initializer: function initializer() {
            return 'H1';
        }
    }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, 'logout', [_dec14], {
        enumerable: true,
        initializer: function initializer() {
