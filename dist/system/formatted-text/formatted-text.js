        ...
        execute: function () {
            ...
            _export('Ui5FormattedText', Ui5FormattedText = (_dec = customElement('ui5-formatted-text'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = computedFrom('_formattedtext'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5FormattedText(element) {
                    ...
                    _initDefineProp(_this, 'htmlText', _descriptor3, _this);

                    _initDefineProp(_this, 'width', _descriptor4, _this);

                    _initDefineProp(_this, 'convertLinksToAnchorTags', _descriptor5, _this);

                    _initDefineProp(_this, 'convertedLinksDefaultTarget', _descriptor6, _this);
            ...
            }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, 'htmlText', [_dec3], {
                enumerable: true,
                initializer: function initializer() {
                    return '';
                }
            ...
            }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'convertLinksToAnchorTags', [_dec5], {
                enumerable: true,
                initializer: function initializer() {
                    return 'None';
                }
            }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'convertedLinksDefaultTarget', [_dec6], {
                enumerable: true,
                initializer: function initializer() {
                    return '_blank';
                }
            }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'height', [_dec7], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
