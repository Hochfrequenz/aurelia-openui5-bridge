...
System.register(['aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../view-settings-item/view-settings-item'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export('Ui5ViewSettingsFilterItem', Ui5ViewSettingsFilterItem = (_dec = customElement('ui5-view-settings-filter-item'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = computedFrom('_viewsettingsfilteritem'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5ViewSettingsItem) {
                ...
                function Ui5ViewSettingsFilterItem(element) {
                    ...
                    _initDefineProp(_this, 'multiSelect', _descriptor2, _this);

                    _initDefineProp(_this, 'filterDetailItemsAggregationChange', _descriptor3, _this);
            ...
            }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, 'multiSelect', [_dec3], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, 'filterDetailItemsAggregationChange', [_dec4], {
                enumerable: true,
                initializer: function initializer() {
