...
System.register(['aurelia-templating', 'aurelia-dependency-injection', '../common/attributeManager', '../common/attributes', '../control/control', '../item/item'], function (_export, _context) {
  ...
  var bindable, customElement, noView, inject, AttributeManager, getBooleanFromAttributeValue, Ui5Control, Ui5Item, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, Ui5ViewSettingsFilterItem;
  ...
  return {
    ...
    execute: function () {
      _export('Ui5ViewSettingsFilterItem', Ui5ViewSettingsFilterItem = (_dec = customElement('ui5-view-settings-filter-item'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Item) {
      ...
      }(Ui5Item), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'multiSelect', [_dec3], {
        enumerable: true,
