        ...
        execute: function () {
            ...
            _export('Ui5Link', Ui5Link = (_dec = customElement('ui5-link'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = bindable(), _dec23 = bindable(), _dec24 = bindable(), _dec25 = bindable(), _dec26 = computedFrom('_link'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5Link(element) {
                    ...
                    _initDefineProp(_this, 'href', _descriptor7, _this);

                    _initDefineProp(_this, 'validateUrl', _descriptor8, _this);
                    ...
                    _initDefineProp(_this, 'subtle', _descriptor12, _this);

                    _initDefineProp(_this, 'emphasized', _descriptor13, _this);
            ...
            }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'target', [_dec5], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            ...
            }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'href', [_dec7], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'validateUrl', [_dec8], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'wrapping', [_dec9], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'textAlign', [_dec10], {
                enumerable: true,
                initializer: function initializer() {
                    return 'Initial';
                }
            ...
            }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, 'subtle', [_dec12], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, 'emphasized', [_dec13], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
