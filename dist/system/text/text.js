        ...
        execute: function () {
            ...
            _export('Ui5Text', Ui5Text = (_dec = customElement('ui5-text'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = computedFrom('_text'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                function Ui5Text(element) {
                    ...
                    _initDefineProp(_this, 'wrapping', _descriptor5, _this);

                    _initDefineProp(_this, 'textAlign', _descriptor6, _this);

                    _initDefineProp(_this, 'width', _descriptor7, _this);

                    _initDefineProp(_this, 'maxLines', _descriptor8, _this);

                    _initDefineProp(_this, 'renderWhitespace', _descriptor9, _this);
                ...
                Ui5Text.prototype.renderWhitespaceChanged = function renderWhitespaceChanged(newValue) {
                    if (this._text !== null) {
                        this._text.setRenderWhitespace(getBooleanFromAttributeValue(newValue));
                    }
                };
            ...
            }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, 'textDirection', [_dec4], {
                enumerable: true,
                initializer: function initializer() {
                    return 'Inherit';
                }
            }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'wrapping', [_dec5], {
                enumerable: true,
                initializer: function initializer() {
                    return true;
                }
            }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'textAlign', [_dec6], {
                enumerable: true,
                initializer: function initializer() {
                    return 'Begin';
                }
            ...
            }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'maxLines', [_dec8], {
                enumerable: true,
                initializer: function initializer() {
                    return null;
                }
            }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'renderWhitespace', [_dec9], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
