...
System.register(['aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../item/item'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export('Ui5ViewSettingsItem', Ui5ViewSettingsItem = (_dec = customElement('ui5-view-settings-item'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = computedFrom('_viewsettingsitem'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Item) {
                ...
                function Ui5ViewSettingsItem(element) {
                    ...
                    _initDefineProp(_this, 'selected', _descriptor3, _this);

                    _initDefineProp(_this, 'itemPropertyChanged', _descriptor4, _this);
                ...
                Ui5ViewSettingsItem.prototype.selectedChanged = function selectedChanged(newValue) {
                    if (this._viewsettingsitem !== null) {
                        this._viewsettingsitem.setSelected(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5ViewSettingsItem.prototype.enabledChanged = function enabledChanged(newValue) {
                    if (this._viewsettingsitem !== null) {
                        this._viewsettingsitem.setEnabled(getBooleanFromAttributeValue(newValue));
                    }
                };
            ...
            }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, 'selected', [_dec3], {
                enumerable: true,
                initializer: function initializer() {
                    return false;
                }
            }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, 'itemPropertyChanged', [_dec4], {
                enumerable: true,
                initializer: function initializer() {
