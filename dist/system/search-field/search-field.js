        ...
        execute: function () {
            ...
            _export('Ui5SearchField', Ui5SearchField = (_dec = customElement('ui5-search-field'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = bindable(), _dec20 = bindable(), _dec21 = bindable(), _dec22 = bindable(), _dec23 = computedFrom('_searchfield'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                Ui5SearchField.prototype.showMagnifierChanged = function showMagnifierChanged(newValue) {
                    if (this._searchfield !== null) {
                        this._searchfield.setShowMagnifier(getBooleanFromAttributeValue(newValue));
                    }
                };
                ...
                Ui5SearchField.prototype.selectOnFocusChanged = function selectOnFocusChanged(newValue) {
                    if (this._searchfield !== null) {
                        this._searchfield.setSelectOnFocus(getBooleanFromAttributeValue(newValue));
                    }
                };
