...
System.register(['aurelia-templating', 'aurelia-dependency-injection', 'aurelia-framework', '../common/attributeManager', '../common/attributes', '../control/control'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export('Ui5TabContainer', Ui5TabContainer = (_dec = customElement('ui5-tab-container'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec12 = bindable(), _dec13 = bindable(), _dec14 = bindable(), _dec15 = bindable(), _dec16 = bindable(), _dec17 = bindable(), _dec18 = bindable(), _dec19 = computedFrom('_tabcontainer'), _dec(_class = _dec2(_class = (_class2 = function (_Ui5Control) {
                ...
                Ui5TabContainer.prototype.blockedChanged = function blockedChanged(newValue) {
                    if (this._tabcontainer !== null) {
                        this._tabcontainer.setBlocked(getBooleanFromAttributeValue(newValue));
                    }
                };
