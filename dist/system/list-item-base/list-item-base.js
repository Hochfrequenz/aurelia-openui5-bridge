...
System.register(['aurelia-templating', 'aurelia-dependency-injection', '../common/attributeManager', '../common/attributes', '../control/control'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export('Ui5ListItemBase', Ui5ListItemBase = (_dec = inject(Element), _dec2 = bindable(), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec6 = bindable(), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec10 = bindable(), _dec11 = bindable(), _dec(_class = (_class2 = function (_Ui5Control) {
      ...
      }(Ui5Control), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'visible', [_dec2], {
        enumerable: true,
