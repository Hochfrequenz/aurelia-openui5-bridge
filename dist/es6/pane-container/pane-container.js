...
if (elem.localName == 'dragdropconfig') { var _index = afterElement?Math.floor(afterElement+1):null; if (_index)this._panecontainer.insertDragDropConfig(child, _index); else this._panecontainer.addDragDropConfig(child, 0);  return elem.localName; }
...
if (relation == 'dragdropconfig') {  this._panecontainer.removeDragDropConfig(child);}
